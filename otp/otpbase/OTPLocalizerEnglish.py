...
lDonaldsDock = "Barnacle Boatyard"
lDonaldsDreamland = "Drowsy Dreamland"
lMinniesMelodyland = "Mezzo Melodyland"
...
SuitBrushOffs = {'f': ["I'm late for a meeting."],
                 'p': ['Push off.'],
                 'ym': ['Yes Man says NO.'],
                 'fc': ["Sorry, I'm feeling \"under the weather\"."],
                 'af': ["I'm waiting for the commercial break."],
                 'ps': ["You ain't worth my time right now.",
                        "I'm looking for the best, and I 'spect you ain't!"],
                 'tr': ["Make a U-turn here, I don't have time for you.",
                        "You'd go dizzy if you tried managing my work."],
                 'gk': ["You'll need to show me a valid ID.",
                        'It would take ages for you to reach my level.'],
                 'fm': ["Call me when you've got something new to sell."],
...
SuitFaceoffTaunts = {'b': ['Do you have a donation for me?',
                     ...
                     'fc': ["Don't you trust the forecasts?",
                            "Today's forecast is very cloudy: expect downfall.",
                            'The market may be dynamic, but the weather is absolute.',
                            'I fore-bid you from going any further.',
                            'Toons, toons, go away!',
                            "I'll make my point, weather or not you care.",
                            "Watch it! I'm part of an umbrella corporation.",
                            "What's wrong, toon? It's perfectly cloudy today."],
                     'af': ["Unlike you, I'll get paid to do this.",
                            'COGS Inc. will personally ensure you go sad or your money back!',
                            'Good luck bribing your way out of this one.',
                            "This battle wouldn't be possible without my sponsors.",
                            "Don't worry; I'll a-fill you in on the details.",
                            "Even if you paid me, I've got my brand loyalty.",
                            'Some say that my long-winded speeches are affable.'],
                     'ps': ["Git going now, toon. I've staked my claim.",
                            "When I'm done here, you'll end up critically panned.",
                            "Victory would be worth its weight in gold.",
                            "You ain't even worth a dollar.",
                            "I'll make you run for the hills.",
                            "Just ask Penny Pincher - I won't settle for copper!",
                            "Tell me, would defeating you increase my profit margin?"],
                     'tr': ['Running into you was not an accident.',
                            'Can you get out of this jam? I think not.',
                            "I'll green-light this project if it means your doom.",
                            "Maybe it's time you slow down.",
                            'You toons have crossed my wires for the last time.',
                            "I'll keep you busy for a long time."],
                     'gk': ['Mr. Hollywood trusts me to keep his word.',
                            "You'll have to gate through me to see the higher-ups.",
                            "Toons like you wouldn't understand good business.",
                            'Keep out, toon!',
                            "Think you can pass? You'll wish you didn't.",
                            "Gate moving, or else I'll stop you myself.",
                            "The corporate ladder won't get you beyond THIS gate!"],
                     'fm': ['I appreciate being the epicenter of attention.',
                            "I've been known to break the Richter Scale.",
                            'If you need shaken up, run to me first.',
                            'Are you not moved to tears?',
                            'Mover & Shaker pales in comparison to me.',
                            'The early bid gets the sales!',
                            "Let's see who has the advantage in this meeting.",
                            'You wish you could be as competitive as me.',
                            "I'm here to set a prime example.",
                            'I am magnitudes above you.']}
...
SpeedChatStaticTextToontown = {100: 'Hi!',
                               ...
                               20351: SuitFaceoffTaunts['fm'][0],
                               20352: SuitFaceoffTaunts['fm'][1],
                               20353: SuitFaceoffTaunts['fm'][2],
                               20354: SuitFaceoffTaunts['fm'][3],
                               20355: SuitFaceoffTaunts['fm'][4],
                               20356: SuitFaceoffTaunts['fm'][5],
                               20357: SuitFaceoffTaunts['fm'][6],
                               20358: SuitFaceoffTaunts['fm'][7],
                               20359: SuitFaceoffTaunts['fm'][8],
                               20360: SuitFaceoffTaunts['fm'][9],
                               20361: SuitFaceoffTaunts['fc'][0],
                               20362: SuitFaceoffTaunts['fc'][1],
                               20363: SuitFaceoffTaunts['fc'][2],
                               20364: SuitFaceoffTaunts['fc'][3],
                               20365: SuitFaceoffTaunts['fc'][4],
                               20366: SuitFaceoffTaunts['fc'][5],
                               20367: SuitFaceoffTaunts['fc'][6],
                               20368: SuitFaceoffTaunts['fc'][7],
                               20369: SuitFaceoffTaunts['ps'][0],
                               20370: SuitFaceoffTaunts['ps'][1],
                               20371: SuitFaceoffTaunts['ps'][2],
                               20372: SuitFaceoffTaunts['ps'][3],
                               20373: SuitFaceoffTaunts['ps'][4],
                               20374: SuitFaceoffTaunts['ps'][5],
                               20375: SuitFaceoffTaunts['ps'][6],
                               21000: 'Here boy!',
                               21001: 'Here girl!',
                               21002: 'Stay.',
                               21003: 'Good boy!',
                               ...
                               30110: 'Mickey is in Daffodil Gardens.',
