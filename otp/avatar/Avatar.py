...
class Avatar(Actor, ShadowCaster):
    ...
    def advancePageNumber(self):
        if self.__chatAddressee == base.localAvatar.doId and self.__chatPageNumber and self.__chatPageNumber[0] == self.__chatParagraph:
    ...
    def __updatePageChat(self):
        if self.__chatPageNumber and self.__chatPageNumber[0] == self.__chatParagraph:
            pageNumber = self.__chatPageNumber[1]
            if pageNumber >= 0:
