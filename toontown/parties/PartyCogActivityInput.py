...
ROTATE_LEFT_KEY = base.MOVE_UP
ROTATE_RIGHT_KEY = base.MOVE_DOWN
FORWARD_KEY = base.MOVE_LEFT
BACKWARDS_KEY = base.MOVE_RIGHT
THROW_PIE_KEYS = [base.JUMP, base.ACTION_BUTTON, base.SECOND_ACTION_BUTTON]
