...
class Playground(Place.Place):
    ...
    def enter(self, requestStatus):
        ...
        if newsManager:
            ...
            if (
                    ToontownGlobals.HALLOWEEN_COSTUMES in holidayIds or ToontownGlobals.SPOOKY_COSTUMES in holidayIds) and self.loader.hood.spookySkyFile:
                lightsOff = Sequence(
    ...
    def enterNPCFA(self, requestStatus):
        ...
        if questHistory != [] and questHistory != [1000] and questHistory != [101, 110]:
            ...
            if Quests.avatarHasTrolleyQuest(base.localAvatar):
                if Quests.avatarHasCompletedTrolleyQuest(base.localAvatar):
    ...
    def enterTeleportIn(self, requestStatus):
        ...
        if self.dialog:
            ...
            self.deathAckBox = DeathForceAcknowledge.DeathForceAcknowledge(doneEvent='deathAck')
                ...
                base.localAvatar) or Quests.avatarHasPhoneQuest(
