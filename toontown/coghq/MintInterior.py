...
MintSoundtracks = {ToontownGlobals.CashbotMintIntA: ['phase_10/audio/bgm/CB_mint_coin.ogg',
                                                     'phase_10/audio/bgm/CB_mint_encntr_coin.ogg'],
                   ToontownGlobals.CashbotMintIntB: ['phase_10/audio/bgm/CB_mint_dollar.ogg',
                                                     'phase_10/audio/bgm/CB_mint_encntr_dollar.ogg'],
                   ToontownGlobals.CashbotMintIntC: ['phase_10/audio/bgm/CB_mint_bullion.ogg',
                                                     'phase_10/audio/bgm/CB_mint_encntr_bullion.ogg']}
...
class MintInterior(BattlePlace.BattlePlace):
    ...
    def load(self):
        ...
        self.mintMusic = base.loader.loadMusic(MintSoundtracks[self.zoneId][0])
        self.loader.setBattleMusic(MintSoundtracks[self.zoneId][1])
    ...
    def enter(self, requestStatus):
        ...
        def commence(self=self):
            ...
            base.playMusic(self.mintMusic, looping=1)
            base.transitions.irisIn()
            mint = bboard.get(DistributedMint.DistributedMint.ReadyPost)
            self.loader.hood.spawnTitleText(mint.mintId, mint.floorNum)

        self.mintReadyWatcher = BulletinBoardWatcher.BulletinBoardWatcher('MintReady',
                                                                          DistributedMint.DistributedMint.ReadyPost,
                                                                          commence)
        self.mintDefeated = 0
    ...
    def enterFLA(self, requestStatus):
        ...
        self.flaDialog = TTDialog.TTGlobalDialog(message=TTLocalizer.ForcedLeaveMintAckMsg, doneEvent='FLADone',
                                                 style=TTDialog.Acknowledge, fadeScreen=1)
