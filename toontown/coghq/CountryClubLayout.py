...
ClubLayout3_0 = [(0, 4, 2, 17), (0, 9, 2, 4, 17), (0, 9, 5, 18)]
ClubLayout3_1 = [(0, 2, 5, 9, 17), (0, 2, 5, 17), (0, 2, 5, 9, 2, 18)]
ClubLayout3_2 = [(0, 2, 9, 4, 17), (0, 4, 9, 2, 17), (0, 2, 6, 9, 2, 6, 18)]
ClubLayout6_0 = [(0, 4, 22, 29, 17),
 (0, 22, 5, 5, 29, 17),
 (0, 22, 29, 6, 17),
 (0, 22, 5, 29, 17),
 (0, 22, 29, 6, 17),
 (0, 22, 5, 29, 29, 18)]
ClubLayout6_1 = [(0, 4, 22, 29, 17),
 (0, 22, 5, 5, 29, 17),
 (0, 22, 29, 6, 17),
 (0, 22, 5, 29, 17),
 (0, 22, 29, 6, 17),
 (0, 22, 5, 29, 29, 18)]
ClubLayout6_2 = [(0, 4, 22, 29, 17),
 (0, 22, 5, 5, 29, 17),
 (0, 22, 29, 6, 17),
 (0, 22, 5, 29, 17),
 (0, 22, 29, 6, 17),
