...
FactorySoundtracks = {ToontownGlobals.SellbotFactoryInt: ['phase_9/audio/bgm/SB_factory.ogg',
                                                          'phase_9/audio/bgm/encntr_fact.ogg',
                                                          'phase_9/audio/bgm/encntr_foreman.ogg']}
...
class FactoryInterior(BattlePlace.BattlePlace):
    ...
    def load(self):
        ...
        self.factoryMusic = base.loader.loadMusic(FactorySoundtracks[self.zoneId][0])
        self.loader.setBattleMusic(FactorySoundtracks[self.zoneId][1])

    def unload(self):
        self.parentFSM.getStateNamed('factoryInterior').removeChild(self.fsm)
        del self.fsm
        del self.factoryMusic
    ...
    def enterFLA(self, requestStatus):
        ...
        self.flaDialog = TTDialog.TTGlobalDialog(message=TTLocalizer.ForcedLeaveFactoryAckMsg, doneEvent='FLADone',
