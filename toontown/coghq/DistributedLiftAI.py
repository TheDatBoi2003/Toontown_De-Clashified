...
class DistributedLiftAI(DistributedEntityAI.DistributedEntityAI):
    ...
    def b_setStateTransition(self, toState, fromState, arrintervalTimestamp):
        self.d_setStateTransition(toState, fromState, arrintervalTimestamp)
        self.setStateTransition(toState, fromState, arrintervalTimestamp)

    def d_setStateTransition(self, toState, fromState, arrintervalTimestamp):
        self.sendUpdate('setStateTransition', [toState, fromState, arrintervalTimestamp])

    def setStateTransition(self, toState, fromState, arrintervalTimestamp):
        self.state = toState
        self.fromState = fromState
        self.stateTimestamp = arrintervalTimestamp
