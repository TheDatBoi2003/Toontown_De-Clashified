...
class DistributedLift(BasicEntities.DistributedNodePathEntity):
    ...
    def setStateTransition(self, toState, fromState, arrintervalTimestamp):
        ...
        if not self.isGenerated():
            ...
            self.initialStateTimestamp = arrintervalTimestamp
        else:
            self.fsm.request('moving', [toState, fromState, arrintervalTimestamp])
    ...
    def enterMoving(self, toState, fromState, arrintervalTimestamp):
        ...
        intervalStartT = globalClockDelta.networkToLocalTime(arrintervalTimestamp, bits=32) - self.moveIval.getDuration()
        self.moveIval.start(globalClock.getFrameTime() - intervalStartT)
