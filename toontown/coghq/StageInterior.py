...
StageSoundtracks = {ToontownGlobals.LawbotStageIntA: ['phase_11/audio/bgm/LB_office.ogg',
                                                      'phase_9/audio/bgm/encntr_suit_winning.ogg'],
                    ToontownGlobals.LawbotStageIntB: ['phase_11/audio/bgm/LB_office.ogg',
                                                      'phase_9/audio/bgm/encntr_suit_winning.ogg'],
                    ToontownGlobals.LawbotStageIntC: ['phase_11/audio/bgm/LB_office.ogg',
                                                      'phase_9/audio/bgm/encntr_suit_winning.ogg'],
                    ToontownGlobals.LawbotStageIntD: ['phase_11/audio/bgm/LB_office.ogg',
                                                      'phase_9/audio/bgm/encntr_suit_winning.ogg']}
...
class StageInterior(BattlePlace.BattlePlace):
    ...
    def load(self):
        ...
        self.stageMusic = base.loader.loadMusic(StageSoundtracks[self.zoneId][0])
        self.loader.setBattleMusic(StageSoundtracks[self.zoneId][1])
    ...
    def enter(self, requestStatus):
        ...
        def commence(self=self):
            ...
            base.playMusic(self.stageMusic, looping=1)
            base.transitions.irisIn()
            stage = bboard.get(DistributedStage.DistributedStage.ReadyPost)
            self.loader.hood.spawnTitleText(stage.stageId)

        self.stageReadyWatcher = BulletinBoardWatcher.BulletinBoardWatcher('StageReady',
                                                                           DistributedStage.DistributedStage.ReadyPost,
                                                                           commence)
    ...
    def enterFLA(self, requestStatus):
        ...
        self.flaDialog = TTDialog.TTGlobalDialog(message=TTLocalizer.ForcedLeaveStageAckMsg, doneEvent='FLADone',
