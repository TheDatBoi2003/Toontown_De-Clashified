...
QuestDict = {
    ...
    8512: (DL_TIER + 2, Cont, (MintQuest, ToontownGlobals.CashbotMintIntB, 1), Same, Same, NA, 8513,
           TTLocalizer.QuestDialogDict[8512]),
    8513: (DL_TIER + 2, Cont, (StageQuest, ToontownGlobals.LawbotStageIntC, 1), Same, Same, NA, 8514,
