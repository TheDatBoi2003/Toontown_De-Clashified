...
lGardens = 'Daffodil Gardens'
lBoatyard = "Barnacle Boatyard"
lDreamland = "Drowsy Dreamland"
lMelodyland = "Mezzo Melodyland"
lToontownCentral = 'Toontown Central'
lToonHQ = 'Toon HQ'
lSellbotHQ = 'Sellbot HQ'
lRaceway = 'Roadster Raceway'
lOutdoorZone = "Acorn Acres"
lGolfZone = "Mini-Golf Area"
lPartyHood = 'Party Grounds'
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'),
                     1000: ('to the', 'in the', 'Playground'),
                     1100: ('to', 'on', 'Bucaneer Boulevard'),
...
DonaldsDock = ('to', 'in', lBoatyard)
ToontownCentral = ('to', 'in', lToontownCentral)
TheBrrrgh = ('to', 'in', lTheBrrrgh)
MinniesMelodyland = ('to', 'in', lMelodyland)
DaisyGardens = ('to', 'in', lGardens)
OutdoorZone = ('to', 'in', lOutdoorZone)
FunnyFarm = ('to the', 'in the', 'Funny Farm')
GoofySpeedway = ('to', 'in', lRaceway)
DonaldsDreamland = ('to', 'in', lDreamland)
...
CogVPs = "Marketing Directors"
ACogVP = 'a Marketing Director'
Supervisor = 'Mint Supervisor'
SupervisorP = 'Mint Supervisors'
ASupervisor = 'a Mint Supervisor'
Clerk = 'Office Clerk'
ClerkP = 'Office Clerks'
AClerk = 'an Office Clerk'
ClubPresident = 'Country Club President'
ClubPresidentP = 'Country Club Presidents'
AClubPresident = 'a Country Club President'
CogCFOs = "Chief Financial Officers"
ACogCFO = 'a Chief Financial Officer'
CogCJs = "Chief Justices"
ACogCJ = 'a Chief Justice'
CogCEOs = "Chief Executive Officers"
ACogCEO = 'a Chief Executive Officer'
TheFish = 'the Fish'
AFish = 'a fish'
Level = 'Level'
...
QuestsDefaultIncompleteProgress = ('You came to the right place, but you need to finish your ToonTask first.',
...
QuestsDefaultComplete = ('Nice work! Here is your reward...', 'Great job, _avName_! Take this reward...',
...
QuestsStageQuestHeadline = 'DEFEAT'
...
QuestsStageQuestDesc = 'a District Attn. Office'
QuestsStageQuestDescC = '%(count)s District Attn. Offices'
QuestsStageQuestDescI = 'some District Attn. Offices'
QuestCountryClubQuestCourse = 'Cog Golf Course'
QuestsCountryClubQuestCourses = 'Cog Golf Courses'
QuestsCountryClubQuestHeadline = 'DEFEAT'
QuestsCountryClubQuestProgressString = '%(progress)s of %(num)s defeated'
QuestsCountryClubQuestString = 'Defeat %s'
QuestsCountryClubQuestSCString = 'I need to defeat %(objective)s %(location)s.'
QuestsCountryClubQuestDesc = 'a Cog Golf Course'
QuestsCountryClubQuestDescC = '%(count)s Cog Golf Courses'
...
QuestsItemDict = {1: ['Pair of Glasses', 'Pairs of Glasses', 'a '],
                  ...
                  2013: ['Salty Sprocket', 'Salty Sprockets', 'a '],
                  2014: ['Salty Spring', 'Salty Springs', 'a '],
                  ...
                  5011: ['Salad', 'Salads', 'a '],
                  5012: ['Key to ' + lGardens, 'Keys to ' + lGardens, 'a '],
                  ...
                  8000: ['Recommendation Letter', 'Recommendation Letters', 'a ']}
...
TheBrrrghTrackQuestDict = {GREETING: '',
                           QUEST: 'Now you are ready.\x07'
                                  'Go out and walk the earth.  Evaluate what you have chosen so far.\x07'
                                  'Understand that this is your final refund point.\x07'
                                  'When you are ready to accept this responsibility, return to me.',
                           COMPLETE: 'Here is your final refund point.  If you do spend it, spend it wisely!',
                           LEAVING: 'Good luck.  Return to me when you are ready for my true challenge.'}
QuestDialog_3225 = {
...
QuestDialogDict = {160: {GREETING: '',
                   ...
                   1041: {
                       QUEST: 'Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Toontown.\x07Why, you can teleport to your friends using the Friends List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to ' + lToontownCentral + ' if you help out a friend of mine.\x07Seems the Cogs are causing trouble over on Loopy Lane.  Go visit _toNpcName_._where_'},
                   1042: {
                       QUEST: 'Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Toontown.\x07Why, you can teleport to your friends using the Friends List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to ' + lToontownCentral + ' if you help out a friend of mine.\x07Seems the Cogs are causing trouble over on Loopy Lane.  Go visit _toNpcName_._where_'},
                   1043: {
                       QUEST: 'Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Toontown.\x07Why, you can teleport to your friends using the Friends List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to ' + lToontownCentral + ' if you help out a friend of mine.\x07Seems the Cogs are causing trouble over on Loopy Lane.  Go visit _toNpcName_._where_'},
                   1044: {
                       QUEST: 'Oh, thanks for stopping by.  I really need some help.\x07As you can see, I have no customers.\x07My secret recipe book is lost and nobody comes to my restaurant anymore.\x07I last saw it just before those Cogs took over my building.\x07Can you help me by recovering four of my famous recipes?',
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Any luck finding my recipes?'},
                   1045: {
                       QUEST: 'Thank you so much!\x07Before long I will have the entire collection and can reopen my restaurant.\x07Oh, I have a note here for you - something about teleport access?\x07It says thanks for helping my friend and to deliver this to Toon Headquarters.\x07Well, thanks indeed - bye!',
                       LEAVING: '',
                   ...
                   1046: {
                       QUEST: 'The Cashbots have really been bothering the Funny Money Savings and Loan.\x07Stop by there and see if there is anything you can do._where_'},
                   1047: {
                       QUEST: 'Cashbots have been sneaking into the bank and stealing our machines.\x07Please recover 3 adding machines from Cashbots.\x07To save you from running back and forth, just bring them all back at once.',
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Still looking for adding machines?'},
                   1048: {
                       QUEST: 'Wow!  Thanks for finding our adding machines.\x07Hm... They look a little damaged.\x07Say, could you take them over to _toNpcName_ over at her shop, "Tickle Machines" on this street?\x07See if she can fix them.',
                       LEAVING: ''},
                   1049: {
                       QUEST: "What's that?  Broken adding machines?\x07Cashbots you say?\x07Well, let's have a look see...\x07Yep, gears are stripped, but I'm out of that part...\x07You know what might work - some Cog gears, premium Bossbot ones.\x07Bring me 3 of them and I'll fix em up!",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Remember, I need 3 Bossbot gears to fix the machines.'},
                   1053: {
                       QUEST: "Ah yes, that should do the trick indeedy.\x07All fixed now, free of charge.\x07Take these back to Funny Money, and tell 'im I said howdy.",
                       LEAVING: '',
                   ...
                   1055: {
                       QUEST: "Yowza!  I can't find the tires to this here clown car anywhere!\x07Do ya think you could help me out?\x07I think Loopy Bob may have tossed them in the pond in the " + lToontownCentral + ' playground.\x07If you stand on one of the docks there you can try and fish out the tires for me.',
                       GREETING: 'Woohoo!',
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Are you having trouble fishing out all 4 tires?'},
                   1056: {
                       QUEST: 'Fan-flying-tastic!  Now I can get this old clown car on the road again!\x07Hey, I thought I had an air pump around here to inflate these tires...\x07Maybe _toNpcName_ borrowed it?\x07Could you go ask for it back for me?_where_',
                       LEAVING: ''},
                   1057: {
                       QUEST: "Hi there.\x07A tire pump you say?\x07I'll tell you what - you help clean up the streets of some of those high level Cogs for me...\x07And I'll let you have the tire pump.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Is that the best you can do?'},
                   1058: {
                       QUEST: "Good job - I knew you could do it.\x07Here's the pump.  I'm sure _toNpcName_ will be glad to get it back.",
                       LEAVING: '',
                       GREETING: '',
                   ...
                   1060: {
                       QUEST: "Thanks for stopping by!\x07Those Cogs have been stealing my ink, so I'm running very low.\x07Could you fish some octopus ink out of the pond for me?\x07Just stand on a dock near the pond to fish.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Are you having trouble fishing?'},
                   1061: {
                       QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Pencil Pushers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Pencil Pushers in " + lToontownCentral + ' for your reward.',
                       LEAVING: '',
                       COMPLETE: 'Thanks!  Let me reward you for your help.',
                       INCOMPLETE_PROGRESS: 'I just saw some more Pencil Pushers.'},
                   1062: {
                       QUEST: "Great - thanks for the ink!\x07You know what, maybe if you cleared away some of those Bloodsuckers...\x07I wouldn't run out of ink again so quickly.\x07Defeat 6 Bloodsuckers in " + lToontownCentral + ' for your reward.',
                       LEAVING: '',
                       COMPLETE: 'Thanks!  Let me reward you for your help.',
                       INCOMPLETE_PROGRESS: 'I just saw some more Bloodsuckers.'},
                   900: {QUEST: 'I hear _toNpcName_ needs help with a package._where_'},
                   1063: {
                       QUEST: 'Hi - thanks for coming in.\x07A Cog stole a very important package from right under my nose.\x07Please see if you can get it back.  I think he was a level 3...\x07So, defeat level 3 Cogs until you find my package.',
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'},
                   1067: {
                       QUEST: "That's it, all right!\x07Hey, the address is smudged...\x07All I can read is that it's for a Dr. - the rest is all blurry.\x07Maybe it's for _toNpcName_?  Could you take it to him?_where_",
                       LEAVING: ''},
                   1068: {
                       QUEST: "I wasn't expecting a package.  Maybe it's for Dr. I.M. Euphoric?\x07My assistant was going over there today anyway, so I'll have him check for you.\x07In the meantime, would you mind getting rid of some of the Cogs on my street?\x07Defeat 5 Cogs on Silly Street.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: "My assistant isn't back yet."},
                   1069: {
                       QUEST: "Dr. Euphoric says he wasn't expecting a package either.\x07Unfortunately, a Cashbot stole it from my assistant on the way back.\x07Could you try and get it back?",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'},
                   1070: {
                       QUEST: "Dr. Euphoric says he wasn't expecting a package either.\x07Unfortunately, a Sellbot stole the package from my assistant on the way back.\x07I'm sorry, but you'll have to find that Sellbot and get it back.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'},
                   1071: {
                       QUEST: "Dr. Euphoric says he wasn't expecting a package either.\x07Unfortunately, a Bossbot stole it from my assistant on the way back.\x07Could you try and get it back?",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'No luck finding the package, huh?'},
                   1072: {
                       QUEST: 'Great - you got it back!\x07Maybe you should try _toNpcName_, it could be for him._where_',
                       LEAVING: ''},
                   1073: {
                       QUEST: 'Oh, thanks for bringing me my packages.\x07Wait a second, I was expecting two.  Could you check with _toNpcName_ and see if he has the other one?',
                       INCOMPLETE: 'Were you able to find my other package?',
                       LEAVING: ''},
                   1074: {
                       QUEST: 'He said there was another package?  Maybe the Cogs stole it too.\x07Defeat Cogs until you find the second package.',
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'No luck finding the other package, huh?'},
                   1075: {
                       QUEST: 'I guess there was a second package after all!\x07Hurry and take it over to _toNpcName_ with my apologies.',
                       COMPLETE: 'Hey, my package is here!\x07Since you seem to be such a helpful Toon, this should come in handy.',
                       LEAVING: ''},
                   1076: {
                       QUEST: "There's been some trouble over at 14 Karat Goldfish.\x07_toNpcName_ could probably use a hand._where_"},
                   1077: {
                       QUEST: "Thanks for coming - the Cogs stole all my goldfish.\x07I think the Cogs want to sell them to make a quick buck.\x07Those 5 fish have been my only companions in this tiny store for so many years...\x07If you could get them back for me I'd really appreciate it.\x07I'm sure one of the Cogs has my fish.\x07Defeat Cogs until you find my goldfish.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Please return my goldfish to me.'},
                   1078: {
                       QUEST: "Oh, you have my fish!\x07Huh?  What's this - a receipt?\x07Sigh, I guess they are Cogs, after all.\x07I can't make heads or tails out of this receipt.  Could you take it to _toNpcName_ and see if he can read it?_where_",
                       INCOMPLETE: 'What did _toNpcName_ have to say about the receipt?',
                       LEAVING: ''},
                   1079: {
                       QUEST: "Mmm, let me see that receipt.\x07...Ah Yes, it says that 1 goldfish was sold to a Flunky.\x07It doesn't seem to mention what happened to the other 4 fish.\x07Maybe you should try and find that Flunky.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: "I don't think there's anything else I can help you with.\x07Why don't you try and find that goldfish?"},
                   1092: {
                       QUEST: "Mmm, let me see that receipt.\x07...Ah Yes, it says that 1 goldfish was sold to a Short Change.\x07It doesn't seem to mention what happened to the other 4 fish.\x07Maybe you should try and find that Short Change.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: "I don't think there's anything else I can help you with.\x07Why don't you try and find that goldfish?"},
                   1080: {
                       QUEST: "Oh thank heavens!  You found Oscar - he's my favorite.\x07What's that, Oscar?  Uh huh... they did? ... they are?\x07Oscar says the other 4 escaped into the pond in the playground.\x07Could you go round them up for me?\x07Just fish them out of the pond.",
                       LEAVING: '',
                   ...
                   1082: {
                       QUEST: "I spilled quick dry glue and I'm stuck - stuck cold!\x07If there were a way out, I sure would be sold.\x07That gives me an idea, if you are feeling loyal.\x07Defeat some Sellbots and bring back some oil.",
                       LEAVING: '',
                       GREETING: '',
                       INCOMPLETE_PROGRESS: 'Can you help me get un-stuck?'},
                   1083: {
                       QUEST: "Well, oil helped a little, but I still cannot budge,\x07What else would help?  It's hard to judge.\x07That gives me an idea; it's worth a try at least.\x07Defeat some Lawbots and bring back some grease.",
                       LEAVING: '',
                       GREETING: '',
                       INCOMPLETE_PROGRESS: 'Can you help me get un-stuck?'},
                   1084: {
                       QUEST: "Nope, that didn't help.  This is really not funny.\x07I put the grease right there on the money,\x07That gives me an idea, before I forget it.\x07Defeat some Cashbots; bring back water to wet it.",
                       LEAVING: '',
                       GREETING: '',
                       ...
                       INCOMPLETE_PROGRESS: 'Can you help me get un-stuck?'},
                   1085: {
                       QUEST: '_toNpcName_ is conducting some research on the Cogs.\x07Go talk to him if you want to help out._where_'},
                   1086: {
                       QUEST: "That's right, I'm conducting a study of the Cogs.\x07I want to know what makes them tick.\x07It sure would help me if you could gather some gears from Cogs.\x07Make sure they're from at least level 2 Cogs so they're big enough to examine.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: "Can't find enough gears?"},
                   1089: {
                       QUEST: "Okay, let's take a look.  These are excellent specimens!\x07Mmmm...\x07Okay, here's my report.  Take this back to Toon Headquarters right away.",
                   ...
                   1091: {
                       ...
                       LEAVING: ''},
                   1093: {
                       QUEST: '_toNpcName_ runs the Impractical Joke store, but she needs something more practical!_where_'},
                   1094: {QUEST: 'So you heard about my problem?  I really could use some help.\x07'
                                 'My impractical jokes are too complicated and do nothing for the cogs!\x07'
                   ...
                   1095: {QUEST: 'Welcome to my Seltzer Shop, how can I help?\x07'
                                 'T.P. Rolle needs some practical gags?\x07'
                                 'Squirt gags are a great choice!  They are reliable, and they soak up those robotic gears.\x07'
                                 'A gag that works well with Squirt is the Zap gag.\x07'
                                 'Go speak to _toNpcName_, they can supply you with plenty of zap gags._where_',
                          LEAVING: "...Oh, don't forget to take the seltzers with you!"},
                   1096: {QUEST: 'Welcome to my emporium!  Shake my hand.\x07'
                                 'BZZT!\x07'
                                 'Heh, gets them every time.\x07'
                                 'So, T.P. Rolle is finally looking for a more practical joke?\x07'
                                 'A large battery would do the trick - lead, perhaps.\x07'
                                 'Make sure it is a fresh battery, we want one that will last.\x07'
                                 'Go obtain one from a level 2+ cog and then take it back to T.P. Rolle.',
                   ...
                   1103: {
                       ...
                       COMPLETE: "What's this, a bonus?\x07"
                                 'An apple, oh how thoughtful of them!\x07'
                                 "It looks like they've also thrown in an extra pouch. Here you go!"},
                   1400: {
                       QUEST: '_toNpcName_ needs help maintaining his inventory._where_'},
                   1401: {
                       GREETING: '',
                       QUEST: 'Oh, greetings, and welcome to ' + lBoatyard + '!  Have you seen my checklist?\x07'
                              'Some Pencil Pushers shoved me aside when I was walking down Buccaneer Boulevard.\x07'
                              'If one of them happened to pick it up, I need to get it back!\x07'
                              'Go defeat Pencil Pushers on that street until you retrieve it.',
                       COMPLETE: 'You found it!  Thank you so much!\x07'
                                 "If you don't mind losing something temporarily, I've got the thing for you...\x07"
                                 '...a Refund Point!\x07'
                   ...
                   2202: {
                       QUEST: "Hi, _avName_. Thank goodness you're here. A mean looking Penny Pincher was just in here and he made off with an inner tube.\x07I fear they may use it for their vile purposes.\x07Please see if you can find him and bring it back.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Any luck finding my inner tube?',
                       COMPLETE: 'You found my inner tube! You ARE good. Here, take your reward...'},
                   2203: {
                       QUEST: TheCogs + ' are wreaking havoc over at the bank.\x07Go see Captain Carl and see what you can do._where_'},
                   2204: {
                       QUEST: "Welcome aboard, matey.\x07Argh! Those rapscallion Cogs smashed my monocle and I can't sort me change without it.\x07Be a good landlubber and take this prescription to _toNpcName_ and fetch me a new one._where_",
                       GREETING: '',
                       LEAVING: ''},
                   2205: {
                       QUEST: "What's this?\x07Oh, I'd love to fill this prescription but the Cogs have been pilfering my supplies.\x07If you can get me the eyeglass frames off a flunky I can probably help you out.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Sorry. No flunky frames, no monocle.'},
                   2206: {
                       QUEST: 'Excellent!\x07Just a second...\x07Your prescription is filled. Please take this monocle straight to Captain Carl._where_',
                       GREETING: '',
                       LEAVING: '',
                       COMPLETE: "Avast Ye!\x07You're gonna earn your sea legs after all.\x07Here ye be."},
                   2207: {
                       QUEST: "Barnacle Barbara has a Cog in her shop!\x07You'd better get over there pronto._where_"},
                   2208: {
                       QUEST: "Gosh! You just missed him, sweetie.\x07There was a Back Stabber in here. He took my big white wig.\x07He said it was for his boss and something about 'legal precedent.'\x07If you can get it back I'd be forever grateful.",
                       LEAVING: '',
                       GREETING: '',
                   ...
                   2209: {
                       QUEST: 'Melville is preparing for an important voyage.\x07Pop in and see what you can do to help sort him out._where_'},
                   2210: {
                       QUEST: "I can use your help.\x07I've been asked by Toon HQ to take a voyage and see if I can find where the Cogs are coming from.\x07I'll need a few things for my ship but I don't have many jellybeans.\x07Stop by and pick up some ballast from Alice. You'll have to do a favor for her to get it._where_",
                       GREETING: 'Howdy, _avName_',
                       LEAVING: ''},
                   2211: {
                       QUEST: "So Melville wants ballast, does he?\x07He still owes me for the last bushel.\x07I'll give it to you if you can clear five Micromanagers off my street.",
                   ...
                   2212: {QUEST: "A deal's a deal.\x07Here's your ballast for that cheapskate Melville._where_",
                          ...
                          LEAVING: ''},
                   2213: {
                       QUEST: "Excellent work. I knew she'd be reasonable.\x07Next I'll need a sailing chart from Art.\x07I don't think my credit is good there either so you'll have to work something out with him._where_",
                       GREETING: '',
                       LEAVING: ''},
                   2214: {
                       QUEST: "Yes, I have the sea chart Melville wants.\x07And if you're willing to work for it I'll let you have it.\x07I'm trying to build an astrolabe to navigate by the stars.\x07I could use three Cog gears to build it.\x07Come back when you've found them.",
                       INCOMPLETE_PROGRESS: "How's it coming with those Cog gears?",
                       GREETING: 'Welcome!',
                       LEAVING: 'Good luck!'},
                   2215: {
                       QUEST: "Ooh! These gears will do rather nicely.\x07Here's the chart. Give it to Melville with my compliments._where_",
                       GREETING: '',
                       LEAVING: '',
                   ...
                   2500: {QUEST: "Hey, can you go deliver these salty sprockets to Hook's Clock Repair?\x07"
                                 "He needs them to build his specialty Captain Clocks._where_"},
                   2501: {
                       QUEST: "Avast! Have ye brought a package for me?\x07"
                              "Nay, sprockets won't do, I don't use belts in my clocks.  The salty air ruins the rubber.\x07"
                              "What I be needin' arr some salty springs.  The ones in those Bean Counters are saltiest of all.\x07"
                              "Go defeat some in " + lBoatyard + " to collect 5 of them.",
                       GREETING: '',
                       LEAVING: 'Fair winds!',
                       COMPLETE: "Aye, good form, _avName_!\x07"
                                 "Hey, care to join me crew?  We're about to sail off to Foreverland!\x07"
                                 "...No?  Very well, take this as a reward."},
                   901: {QUEST: "If you're up for it Ahab could use some assistance over at his place..._where_"},
                   2902: {
                       QUEST: "Are you the new recruit?\x07Good, good. Maybe you can help me.\x07I'm building a giant prefab crab to confuse the Cogs.\x07I could use a clovis though. Go see Claggart and bring one back, please._where_"},
                   2903: {
                       QUEST: "Hi there!\x07Yes, I heard about the giant crab Ahab's working on.\x07The best clovis I have is a little on the dirty side though.\x07Be a sport and run it by the cleaners for me before you drop it off._where_",
                       LEAVING: 'Thanks!'},
                   2904: {
                       QUEST: 'You must be the one that Claggart sent over.\x07I think I can clean that up in short order.\x07Just a minute...\x07There you are. Good as new!\x07Tell Ahab I said hello._where_'},
                   2905: {
                       QUEST: "Ah, now this is exactly what I was looking for.\x07While you're here, I'm also going to need a very large clock spring.\x07Take a walk over to Hook's place and see if he has one._where_"},
                   2906: {
                       QUEST: "A large spring, eh?\x07I'm sorry but the largest spring I have is still quite small.\x07Perhaps I could assemble one out of squirt gun trigger springs.\x07Bring me three of these gags and I'll see what I can do."},
                   2907: {
                       QUEST: "Let's have a look then...\x07Smashing. Simply Smashing.\x07Sometimes I even surprise myself.\x07Here you go: one large spring for Ahab!_where_",
                       LEAVING: 'Bon Voyage!'},
                   2911: {
                       QUEST: "I'd be happy to help the cause, _avName_.\x07But I'm afraid the streets are no longer safe.\x07Why don't you go take out some Cashbot Cogs and we'll talk.",
                       INCOMPLETE_PROGRESS: 'I still think you need to make the streets safer.'},
                   2916: {
                       QUEST: 'Yes, I have a weight that Ahab can have.\x07I think it would be safer if you defeated a couple sellbots first though.',
                       INCOMPLETE_PROGRESS: 'Not yet. Defeat some more sellbots.'},
                   2921: {
                       QUEST: "Hmmm, I suppose I could give up a weight.\x07I'd feel a lot better about it if there weren't so many Bossbot Cogs creeping around.\x07Defeat six and then come see me.",
                       INCOMPLETE_PROGRESS: "I don't think its safe yet..."},
                   2925: {
                       QUEST: "All done?\x07Well, I guess it's safe enough now.\x07Here's the counter weight for Ahab._where_"},
                   2926: {
                       QUEST: "Well, that's everything.\x07Let's see if it works.\x07Hmmm, one small problem.\x07I'm not getting any power because that Cog building is blocking my solar panel.\x07Could you retake it for me?",
                   ...
                   3200: {
                       QUEST: "I just got a call in from _toNpcName_.\x07He's having a hard day. Maybe you can help him out!\x07Drop by and see what he needs._where_"},
                   3201: {
                       QUEST: 'Oh, thanks for coming!\x07I need someone to take this new silk tie to _toNpcName_.\x07Would you be able to do that for me?_where_'},
                   3203: {
                       QUEST: 'Oh, this must be the tie I ordered! Thanks!\x07It matches a pinstripe suit I just finished, right over here.\x07Hey, what happened to that suit?\x07Oh no! The Cogs must have stolen my new suit!\x07Defeat Cogs until you find my suit, and bring it back to me.',
                       LEAVING: '',
                   ...
                   3204: {
                       QUEST: "_toNpcName_ just called to report a theft.\x07Why don't you stop by and see if you can sort things out?_where_"},
                   3205: {
                       QUEST: "Hello, _avName_! Have you come to help me?\x07I just chased a Bloodsucker out of my shop. Whew! That was scary.\x07But now I can't find my scissors anywhere! I'm sure that Bloodsucker took them.\x07Find that Bloodsucker, and recover my scissors for me.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Are you still looking for my scissors?',
                       COMPLETE: 'My scissors! Thank you so much! Here is your reward...'},
                   3206: {
                       QUEST: 'It sounds like _toNpcName_ is having problems with some Cogs.\x07Go see if you can help him out._where_'},
                   3207: {
                       QUEST: 'Hi, _avName_! Thanks for coming by!\x07A bunch of Double Talkers just broke in and stole a stack of postcards from my counter.\x07Please go out and defeat all those Double Talkers to get my postcards back!',
                   ...
                   3208: {
                       QUEST: "We've been getting complaints from the residents lately about all of the Cold Callers.\x07See if you can defeat 10 Cold Callers to help out your fellow Toons in " + lGardens + '.'},
                   3209: {
                       QUEST: 'Thanks for taking care of those Cold Callers!\x07But now the Telemarketers have gotten out of hand.\x07Defeat 10 Telemarketers in ' + lGardens + ' and come back here for your reward.'},
                   3247: {
                       QUEST: "We've been getting complaints from the residents lately about all of the Bloodsuckers.\x07See if you can defeat 20 Bloodsuckers to help out your fellow Toons in " + lGardens + '.'},
                   3210: {
                       QUEST: "Gopher's gags is running short on their gag supply!\x07Take them ten of your own gags to help out.\x07Make sure you have at least 10 level 3 gags in your inventory first.",
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: "I need to have 10 level 3 gags. You don't have enough!"},
                   3211: {
                       QUEST: "Oh, thank you so much! Those gags will save the day.\x07But I'm scared of the Cogs outside.\x07Can you help me out and defeat some of those Cogs?\x07Come back to me after you have defeated 8 Cogs on this street.",
                   ...
                   3212: {
                       QUEST: '_toNpcName_ needs some help looking for something she lost.\x07Go visit her and see what you can do._where_'},
                   3213: {
                       QUEST: 'Hi, _avName_. Can you help me?\x07I seem to have misplaced my pen. I think maybe some Cogs took it.\x07Defeat Cogs to find my stolen pen.',
                       INCOMPLETE_PROGRESS: 'Have you found my pen yet?'},
                   3214: {
                       QUEST: "Yes, that's my pen! Thanks so much!\x07But while you were gone I realized my inkwell was missing too.\x07Defeat Cogs to find my inkwell.",
                       INCOMPLETE_PROGRESS: "I'm still looking for my inkwell!"},
                   3215: {
                       QUEST: "Great! Now I have my pen and my inkwell back!\x07But wouldn't you know it?\x07My notepad is gone! They must have stolen it too!\x07Defeat Cogs to find my stolen notepad, and then bring it back for your reward.",
                       INCOMPLETE_PROGRESS: 'Any word on that notepad yet?'},
                   3216: {
                       QUEST: "That's my notepad! Hooray! Your reward is...\x07Hey! Where did it go?\x07I had your reward right here in my office lockbox. But the whole lockbox is gone!\x07Can you believe it? Those Cogs stole your reward!\x07Defeat Cogs to recover my lockbox.\x07When you bring it back to me I'll give you your reward.",
                   ...
                   3217: {
                       QUEST: "We've been performing some studies on Sellbot mechanics.\x07We still need to study some pieces more closely.\x07Bring us a sprocket from a Glad Hander.\x07You can catch one when the Cog is exploding."},
                   3218: {
                       QUEST: 'Great! Now we need just one more sprocket.\x07This time, we need a sprocket from a Mover & Shaker.\x07When you catch one, bring it back for your reward.'},
                   3244: {
                       QUEST: "We've been performing some studies on Lawbot mechanics.\x07We still need to study some pieces more closely.\x07Bring us a sprocket from an Back Stabber.\x07You can catch one when the Cog is exploding."},
                   3245: {
                       QUEST: 'Great! Now we need just one more sprocket.\x07This time, we need a sprocket from a Spin Doctor.\x07When you catch one, bring it back for your reward.'},
                   3220: {
                       QUEST: "I just heard that _toNpcName_ was asking around for you.\x07Why don't you drop by and see what she wants?_where_"},
                   3221: {
                       QUEST: 'Hi, _avName_! There you are!\x07I heard you were quite an expert in tackling cogs.\x07I happen to sell some of the best squirt gags in ' + lGardens + '.\x07If you can show how proficient gags are at taking out cogs, that would attract more customers!\x07If you or your friends have squirt gags, use those!\x07When you have defeated 12 Cogs, come back here for a reward!'},
                   3222: {
                       QUEST: "It's time to demonstrate your Toonmanship.\x07If you successfully reclaim a number of Cog buildings, you'll earn the right to carry three quests.\x07First, defeat a two+ story Cog building.\x07Feel free to call on your friends to help you out."},
                   3223: {
                       QUEST: 'Great job on that building!\x07Now, defeat a three story building.\x07It can be for any department, but it has to be three stories or higher.'},
                   3224: {
                       QUEST: 'Fantastic!\x07Now just defeat one more building.\x07This building must be at least FOUR stories high.\x07When you finish, come back for your reward!',
                       COMPLETE: 'You did it, _avName_!\x07You demonstrated your superior Toonmanship.',
                       GREETING: ''},
                   3225: {
                       QUEST: "_toNpcName_ says she needs some help.\x07Why don't you go see what you can do to help out?_where_"},
                   3235: {
                       QUEST: "Oh, this is the salad I ordered!\x07Thank you for bringing it to me.\x07All those Cogs must have frightened away _toNpcName_'s regular delivery person again.\x07Why don't you do us a favor and defeat some of the Cogs out there?\x07Defeat 8 Cogs in " + lGardens + ' and then report back to _toNpcName_.',
                   ...
                   3236: {
                       QUEST: 'There are far too many Lawbots out there.\x07You can do your part to help!\x07Defeat 3 Lawbot buildings.'},
                   3237: {
                       QUEST: 'Great job on those Lawbot buildings!\x07But now there are too many Sellbots!\x07Defeat 3 Sellbot buildings, then come back for your reward.'},
                   3238: {
                       QUEST: 'Oh no! A "Mingler" Cog has stolen the Key to ' + lGardens + '!\x07See if you can recover it.\x07Remember, The Mingler can be found only inside Sellbot buildings.'},
                   3239: {
                       QUEST: "You found a key all right, but it isn't the right one!\x07We need the Key to " + lGardens + '.\x07Keep looking! A "Mingler" Cog still has it!'},
                   3242: {
                       QUEST: 'Oh no! A Legal Eagle Cog has stolen the Key to ' + lGardens + '!\x07See if you can recover it.\x07Remember, Legal Eagles can be found only inside Lawbot buildings.'},
                   3243: {
                       QUEST: "You found a key all right, but it isn't the right one!\x07We need the Key to " + lGardens + '.\x07Keep looking! A Legal Eagle Cog still has it!'},
                   3240: {
                       QUEST: "I've just heard from _toNpcName_ that a Legal Eagle stole a bag of his bird seed.\x07Defeat Legal Eagles until you recover Bud's bird seed, and take it to him.\x07Legal Eagles are only found inside Lawbot buildings._where_",
                   ...
                   3241: {
                       QUEST: 'Some of the Cog buildings out there are getting too tall for our comfort.\x07See if you can bring down some of the tallest buildings.\x07Rescue 5 3-story buildings or taller and come back for your reward.'},
                   3250: {
                       QUEST: 'Detective Lima over on Tulip Terrace has heard some reports of a Sellbot Headquarters.\x07Head over there and help her investigate.'},
                   3251: {
                   ...
                   3252: {
                       QUEST: "Ok, spill the beans.\x07What's that you say?\x07Sellbot Headquarters?? Oh no!!! Something must be done.\x07We must notify Judge McIntosh - she'll know what to do.\x07Go at once and tell her what you have found out. She's just down the street."},
                   3253: {
                   ...
                   3255: {
                       QUEST: '_toNpcName_ is investigating Sellbot Headquarters.\x07Go see if you can help._where_'},
                   3256: {
                       QUEST: '_toNpcName_ is investigating Sellbot Headquarters.\x07Go see if you can help._where_'},
                   3257: {
                       QUEST: '_toNpcName_ is investigating Sellbot Headquarters.\x07Go see if you can help._where_'},
                   3258: {
                       QUEST: 'There is much confusion about what the Cogs are up to in their new headquarters.\x07I need you to bring back some information directly from them.\x07If we can get four internal memos from Sellbots inside their HQ, that will clear things up.\x07Bring back your first memo to me so we can learn more.'},
                   3259: {
                       QUEST: 'Great! This let\'s see what the memo says....\x07"Attn Sellbots:"\x07"I\'ll be in my office at the top of Sellbot Towers promoting Cogs to higher levels."\x07"When you earn enough merits enter the elevator in the lobby to see me."\x07"Break time\'s over - back to work!"\x07"Signed, The Director of Marketing."\x07Aha.... Flippy will want to see this. I\'ll send it to him right now.\x07Please go get your second memo and bring it back.'},
                   3260: {
                   ...
                   3264: {
                       QUEST: "_toNpcName_ wants to start an investigation on the cogs in Sellbot HQ.\x07Visit her and get she scoop!_where_"},
                   3265: {GREETING: 'Hello, _avName_.',
                          QUEST: 'Are you ready to infiltrate Sellbot HQ once more?\x07Based on our previous investigations, I\'ve determined that the Sellbot factories are leaving a major carbon footprint!\x07Team up, and infiltrate the Factory to see what those cogs are up to.\x07If we can get info on what they are producing, that would help my case.\x07Defeat 10 of the cogs, but not the weaker ones.  They don\'t usually have much information on them.\x07Return to me once you\'ve cleared enough of them.',
                          LEAVING: 'Keep an eye out!',
                          COMPLETE: 'Excellent investigating!\x07It seems that you have obtained more suit pieces.\x07Those Sellbots seem keen on entering and exiting those doors in front of the main tower.\x07If you make a full suit, then perhaps you can make take this \'secret entrance\'.\x07In the meanwhile, here\'s something I think you would find useful.'},
                   3266: {
                       QUEST: "_toNpcName_ want you to prove your prowess one last time._where_"},
                   3267: {GREETING: 'Hello again, buddy!',
                          QUEST: 'Lima and I hatched an idea to better learn the Sellbot\'s motives.\x07Those Sellbots want to increase production rates, but we can\'t let that happen!\x07I need you to re-enter the factory and take out 8 of those skelecogs.\x07They are more uncommon than your regular cogs, so you might want to explore a bit further.\x07Taking on the full factory is a real challenge, so make sure you are fully stocked.\x07Once you defeat enough of them, come back to me.',
                          COMPLETE: 'Radical! This will surely tamper with their production rates now.\x07If you got the full suit, get some friends, and then enter those tower doors.\x07I let the Toon Resistance know about the plans to infiltrate the offices.\x07I have something that will definitely help you tackle what\'s inside!'},
                   3268: {
                       QUEST: "Go defeat 25 Sellbots in Sellbot Headquartes, and then return to Toon HQ for a report."},
                   3269: {
                       QUEST: 'Hey there, _avName_!  Did you complete the task?\x07'
                              'Good.  Now, deliver this report to _toNpcName_ and see what he has to say about it._where_',
                       COMPLETE: 'Hello again, _avName_.  Do you have something for me?\x07'
                                 'A report on Sellbot Headquarters? Excellent!\x07'
                                 'I was actually studying the oil refining process right before you just got here.\x07'
                                 "For your efforts, I've got something you'd really appreciate."},
                   4001: {GREETING: '',
                   ...
                   4202: {
                       QUEST: 'Yes, I talked to Tom this morning.\x07I have the inventory right here.\x07Bring it right back to him, ok?_where_'},
                   4203: {QUEST: "Great! One down...\x07Now swing by and get Yuki's._where_"},
                   4204: {
                       QUEST: 'Oh! The inventory!\x07I forgot all about it.\x07I bet I can have it done by the time you defeat 10 Cogs.\x07Stop in after that and I promise it will be ready.',
                       INCOMPLETE_PROGRESS: '31, 32... DOH!\x07You made me lose count!',
                       GREETING: ''},
                   4205: {
                       QUEST: 'Ah, there you are.\x07Thanks for giving me some time.\x07Take this to Tom and tell him I said Hello._where_'},
                   4206: {
                       QUEST: "Hmmm, very interesting.\x07Now we are getting somewhere.\x07Ok, the last inventory is Fifi's._where_"},
                   4207: {
                       QUEST: "Inventory?\x07How can I do an inventory if I don't have the form?\x07Go see Cleff and see if he has one for me._where_",
                       INCOMPLETE_PROGRESS: 'Any sign of that form yet?'},
                   4208: {
                       QUEST: "Sure I got an inventory form, mon!\x07But dey ain't free, you know.\x07I'll tell you woht. I trade you for a really nice gag.",
                       GREETING: 'Hey, mon!',
                       LEAVING: 'Cool runnings...',
                       INCOMPLETE_PROGRESS: "No, dat won't do.\x07I want one BIGGER den dat! Bring a level 5 gag, mon."},
                   4209: {GREETING: '',
                   ...
                   4212: {
                       QUEST: "Whew! I'm glad Toon HQ finally sent somebody.\x07I haven't had a customer in days.\x07It's these darned Number Crunchers every where.\x07I think they are teaching our residents bad oral hygiene.\x07Defeat ten of them and let's see if business picks up.",
                       INCOMPLETE_PROGRESS: 'Still no customers. But keep it up!'},
                   4213: {
                       QUEST: "You know maybe it wasn't the Number Crunchers after all.\x07Maybe it's just the Cashbots in general.\x07Take out twenty of them and hopefully someone will come in for at least a checkup.",
                   ...
                   4215: {
                       QUEST: "Anna desperately needs someone to help her.\x07Why don't you drop in and see what you can do._where_"},
                   4216: {
                       QUEST: "Thanks for coming so quickly!\x07Seems like the Cogs have made off with several of my customers' cruise tickets.\x07Yuki said she saw a Glad Hander leaving here with his glad hands full of them.\x07See if you can get Lumber Jack's ticket to Alaska back.",
                       INCOMPLETE_PROGRESS: 'Those Glad Handers could be anywhere now...'},
                   4217: {
                       QUEST: "Oh, great. You found it!\x07Now be a trooper and run in by Jack's for me, would you?_where_"},
                   4218: {
                       QUEST: "Great Googely Moogely!\x07Alaska here I come!\x07I can't take these infernal Cogs anymore.\x07Say, I think Anna needs you again._where_"},
                   4219: {
                       QUEST: "Yup, you guessed it.\x07I need you to shake down those pesky Glad Handers for Tabitha's ticket to Jazzfest.\x07You know the procedure...",
                   ...
                   4222: {
                       QUEST: "This is the last one, I promise!\x07Now you are looking for Barry's ticket to the big singing contest.",
                   ...
                   4225: {
                       QUEST: "Defeat some Cog Buildings to find a Production Notice, then return to Toon HQ."},
                   4226: {
                       QUEST: '...Could it be?\x07'
                              'Yes, this is just what we needed!\x07'
                              'Deliver them to _toNpcName_ so that he may research them._where_',
                       COMPLETE: 'Not now, _avName_, Toon HQ keeps bugging me for some reason.\x07'
                                 'Oh, is this what they are messaging me about?  A production notice?\x07'
                                 '...This is just standard cog building production info, I have dozens of these.\x07'
                                 'Sorry, _avName_!  I hope this reward makes up for that.'},
                   902: {QUEST: 'Go see Leo.\x07He needs someone to deliver a message for him._where_'},
                   4903: {
                       QUEST: 'Dude!\x07My castanets are all cloudy and I have a big show tonight.\x07Take them to Carlos and see if he can polish them up._where_'},
                   ...
                   4905: {
                       QUEST: "Jes! Dat's it!\x07Now I need a leetle time to polish dees.\x07Why don juo go takeover a one story beelding while I work?",
                       GREETING: 'Hola!',
                       LEAVING: 'Adios!',
                   ...
                   4908: {
                       QUEST: "Hello there!\x07Hmmm, I don't have a copy of that song handy.\x07If you give me a little while I could transcribe it from memory.\x07Why don't you run along and reclaim a two story building while I write?"},
                   4909: {
                       QUEST: "I'm sorry.\x07My memory is getting a little fuzzy.\x07If you go reclaim a three story building I'm sure I'll be done when you get back..."},
                   ...
                   5247: {
                       QUEST: 'This neighborhood is pretty tough...\x07You might want to learn some new tricks.\x07_toNpcName_ taught me everything I know, so maybe he can help you too._where_'},
                   ...
                   5263: {GREETING: '',
                          ...
                          COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'},
                   5202: {
                       QUEST: lTheBrrrgh + " has been overrun with some of the toughest Cogs we've seen yet.\x07You will probably want to carry more gags around here.\x07I hear _toNpcName_ may have a large bag you can use to carry more gags._where_"},
                   ...
                   5210: {
                       QUEST: '_toNpcName_ is secretly in love with someone in the neighborhood.\x07If you help her, she may reward you handsomely._where_'},
                   ...
                   5266: {GREETING: 'Boo hoo.',
                          ...
                          INCOMPLETE_PROGRESS: 'Please find my letter.'},
                   5212: {
                       QUEST: 'Oh, thank you for finding my letter!\x07Please, please, please could you deliver it to the most handsome dog in the neighborhood?',
                       GREETING: '',
                       LEAVING: '',
                   ...
                   5225: {
                       QUEST: 'Ever since the incident with the turnip bread, Grumpy Phil has been mad at _toNpcName_.\x07Maybe you could help Gus fix things between them?_where_'},
                   5226: {
                       QUEST: 'Yeah, you probably heard Grumpy Phil is mad at me...\x07I was just trying to be nice with that turnip bread.\x07Maybe you can help cheer him up.\x07Phil really hates those Cashbot Cogs, especially their buildings.\x07If you reclaim some Cashbot buildings, it might help.',
                       LEAVING: '',
                       INCOMPLETE_PROGRESS: 'Maybe a few more buildings?'},
                   5227: {QUEST: "That's terrific!  Go tell Phil what you've done._where_"},
                   5228: {
                       QUEST: 'Oh he did, did he?\x07That Gus thinks he can get off so easy, does he?\x07Only broke my tooth, he did, with that turnip bread of his!\x07Maybe if you took my tooth to Dr. Mumbleface for me he could fix it.',
                       GREETING: 'Mmmmrrphh.',
                   ...
                   5232: {
                       QUEST: "Oh, thanks.\x07Mmmrrrphhhh\x07How's that look, huh?\x07Okay, you can tell Gus that I forgive him.",
                       LEAVING: '',
                       GREETING: ''},
                   5233: {
                       QUEST: "Oh, that's great to hear.\x07I figured old Phil couldn't stay mad at me.\x07As a gesture of goodwill, I baked him this Pine cone bread.\x07Could you run it over to him for me?",
                       GREETING: '',
                       LEAVING: '',
                   ...
                   5281: {GREETING: '',
                          ...
                          INCOMPLETE_PROGRESS: 'Did you find any powder?'},
                   5241: {
                       QUEST: 'Okay.\x07As I once said, to truly throw a pie, you must throw not with the hand...\x07...but with the soul.\x07I know not what that means, so I will sit and contemplate while you restore buildings.\x07Return when you have completed your task.',
                       LEAVING: '',
                   ...
                   5243: {
                       QUEST: 'Sweaty Pete is starting to stink up the street.\x07Can you talk him into taking a shower or something?_where_'},
                   5244: {GREETING: '',
                   ...
                   5246: {
                       QUEST: "The ducky's great, but...\x07All those buildings around here make me nervous.\x07I'd feel a lot more relaxed if there were fewer buildings around.",
                       LEAVING: '',
                       COMPLETE: "Okay, I'll shower up now.  And here's something for you too.",
                       INCOMPLETE_PROGRESS: "I'm still worried about buildings."},
                   5251: {
                       QUEST: 'Lounge Lassard is supposed to be playing a gig tonight.\x07I hear he might be having some trouble with his equipment._where_'},
                   5252: {GREETING: '',
                   ...
                   5284: {GREETING: '',
                          ...
                          INCOMPLETE_PROGRESS: "I can't perform barefoot, can I?"},
                   5255: {
                       QUEST: 'You look like you could use more Laff points.\x07Maybe _toNpcName_ could sort you out._where_'},
                   5256: {GREETING: '',
                          LEAVING: '',
                   ...
                   5301: {
                       QUEST: "I can't help you with Laff points, but maybe _toNpcName_ will cut you a deal.\x07He's a little on tempermental side though..._where_"},
                   5302: {GREETING: '',
                          LEAVING: '',
                   ...
                   5303: {
                       QUEST: lTheBrrrgh + " is teeming with very dangerous Cogs.\x07If I were you, I'd carry more gags around here.\x07I hear _toNpcName_ can make you a large bag if you are willing to do the legwork._where_"},
                   5304: {GREETING: '',
                          LEAVING: '',
                   ...
                   5313: {QUEST: '_toNpcName_ is gathering information on the climate of Lawbot HQ.\x07'
                                 'Could you check in on him?_where_'},
                   5314: {GREETING: 'Oh, hello there!',
                          LEAVING: '',
                   ...
                   5315: {GREETING: 'Here, hand me that sensor.',
                          ...
                          QUEST: '...So the exact temperature outside is 20 degrees Fahrenheit...\x07'
                                 'There.  Now, I need to compare this to the temperature inside of Lawbot HQ.\x07'
                                 "I would prefer if you were to collect data in one place.\x07"
                                 "Either the courtyard or the offices will do."},
                   5316: {GREETING: '',
                          LEAVING: '',
                          QUEST: "Okay, so it seems that the Lawbots like to keep their rooms at...\x07"
                                 "...A chilly 10 degrees Fahrenheit! Brrr!\x07"
                                 "Okay then, I've finished writing my report.  Can you deliver it to Professor Pete?",
                          COMPLETE: 'Hey there, _avName_, got another report for me?\x07'
                                    'Professor Flake!  He was my buddy in snow-boarding school.\x07'
                                    "...No, I don't snowboard, it was just a boarding school in The Brrrgh.\x07"
                                    "Anyways, I'll take a look at his report.  As for you..."},
                   ...
                   6206: {
                       QUEST: "Well, _avName_, I don't have anything for you right now.\x07Wait! I think Susan Siesta was looking for help. Why don't you go see her?_where_"},
                   6207: {GREETING: '',
                          LEAVING: '',
                   ...
                   6211: {
                       QUEST: 'Hey _avName_! I heard Lawful Linda was looking for you.\x07You should stop by and pay her a visit._where_'},
                   6212: {GREETING: '',
                          LEAVING: '',
                   ...
                   6231: {
                       QUEST: 'Nat over on Pajama Place wants to reduce the power draw in town.\x07Head over there and see if you can help him out._where_'},
                   6232: {GREETING: '',
                          LEAVING: "Don't let the bed bugs bite!",
                          QUEST: "Hey, _avName_, are you experienced in taking on the Cog Headquarters?\x07"
                                 "They simply draw too much eletricity!\x07"
                                 "It's making the street lights go out!\x07"
                                 "This is bad for my poor friend, P.J. and his taxi services.\x07"
                                 "Ask 'em which Headquarters he thinks you should tackle._where_ ",
                          INCOMPLETE_PROGRESS: "You haven't seen P.J. yet? What's keeping you?\x07Oh, these darn fleas!"},
                   6233: {GREETING: '',
                          LEAVING: '',
                          QUEST: "Hey there _avName_, where can I take you?\x07"
                                 "A Cog Headquarters?  Sorry, I can't go far with the lights dimming out.\x07"
                                 "Oh, you're here to fix the power draw?  Okay then, let's see...\x07"
                                 "Go to Sellbot Headquarters and defeat the Director\x07"
                                 "His tower has way too many searchlights!",
                          INCOMPLETE_PROGRESS: "Did you stop the Director?  He's a real menace."},
                   6234: {GREETING: '',
                          LEAVING: '',
                          QUEST: "Hey there _avName_, where can I take you?\x07"
                                 "A Cog Headquarters?  Sorry, I can't go far with the lights dimming out.\x07"
                                 "Oh, you're here to fix the power draw?  Okay then, let's see...\x07"
                                 "Go to Cashbot Headquarters and clear a Bullion Mint.\x07"
                                 "It takes a lot of power to smash those metal bars.",
                          INCOMPLETE_PROGRESS: "Did you clear a Bullion Mint?  You gotta disable those machines."},
                   6235: {GREETING: '',
                          LEAVING: '',
                          QUEST: "Hey there _avName_, where can I take you?\x07"
                                 "A Cog Headquarters?  Sorry, I can't go far with the lights dimming out.\x07"
                                 "Oh, you're here to fix the power draw?  Okay then, let's see...\x07"
                                 "Go to Lawbot Headquarters and clear a D.A. Office B.\x07"
                                 "The cogs there seem frantic about running laser puzzles 24/7.",
                          INCOMPLETE_PROGRESS: "Did you clear D.A. Office B?  You gotta turn off those lights."},
                   6236: {GREETING: '',
                          LEAVING: '',
                          QUEST: "Hey there _avName_, where can I take you?\x07"
                                 "A Cog Headquarters?  Sorry, I can't go far with the lights dimming out.\x07"
                                 "Oh, you're here to fix the power draw?  Okay then, let's see...\x07"
                                 "Go to Bossbot Headquarters and clear a Front Three.\x07"
                                 "...Granted, they don't use much electricity there.\x07"
                                 "Okay, maybe the Golf Carts there run on electricity?",
                          INCOMPLETE_PROGRESS: "Did you clear a Front Three?  You gotta unplug those carts."},
                   6237: {GREETING: '',
                          LEAVING: '',
                          QUEST: "Alright, I can already see the lights coming back on!\x07"
                                 "Great work, _avName_.  Now I can drive the streets safely!\x07"
                                 "Go talk to Nat and tell him the news.",
                          INCOMPLETE_PROGRESS: "Go tell Nat!  He would like to know his plan worked.",
                          COMPLETE: "That's great news!  P.J. will be up and  running in no time.\x07"
                                    "I've got a nice reward for you.  Thanks again for your help!"},
                   6241: {
                   ...
                   6292: {
                       QUEST: 'Oh those darn Cogs! They stole my reading lamp!\x07I need it back right away. Can you go look for those cogs?\x07If you can get my reading lamp, I can provide a laff boost.\x07Hurry!',
                       INCOMPLETE_PROGRESS: 'I need that lamp back. Keep looking for it!',
                       COMPLETE: "You're back! And you got my lamp!\x07I can't thank you enough but I can give you this."},
                   ...
                   7206: {GREETING: '',
                          ...
                          COMPLETE: 'What a lovely bed!\x07Now my customers will be happy. Thanks, _avName_.\x07Say, you could use some beauty rest yourself.'},
                   ...
                   7223: {GREETING: '',
                          ...
                          COMPLETE: 'I knew Tex would have some harder pillows.\x07Oh yes, those are perfect. Nice and hard.\x07Here, this will make up for the effort.'},
                   ...
                   7236: {GREETING: '',
                          ...
                          COMPLETE: "Fuchsia pajamas with feet! Purr-fect!\x07Ah, now I'm all set. Let's see....\x07Oh, I suppose I should give you something for helping me out.\x07Here! I know you cog experts enjoy having lots of laff."},
                   8500: {QUEST: "Go see Smudgy Mascara. She's been looking for some help._where_"},
                   8501: {GREETING: '',
                          LEAVING: '',
                   ...
                   8510: {QUEST: "Have you heard about the Toon Resistance?\x07"
                                 "It's a team of expert toons who help deal with cogs on a larger scale.\x07"
                                 "If you want to be recruited into the Resistance, go ask Whispering Willow if they need help._where_"},
                   8511: {GREETING: 'Toons of the World, Unite!',
                          QUEST: "Are you the new recruit?  Welcome to the Resistance!\x07"
                                 "If you think you have what it takes, you will have to infiltrate each Cog HQ.\x07"
                                 "First, go clear a Sellbot Factory.", },
                   8512: {GREETING: '',
                          LEAVING: '',
                   ...
                   8514: {GREETING: '',
                          ...
                          QUEST: "Very good!  Now, for Bossbot HQ.\x07"
                                 "Drive down the Back Nine.  It could take a long time, so be ready!"},
                   8515: {GREETING: '',
                          LEAVING: '',
                          QUEST: "OK, I think that covers them all!\x07"
                                 "Now, to officially certify you, I'll sign this paper right here...\x07"
                                 "There! Deliver this to Flippy, and he will officially recruit you.",
                          INCOMPLETE_PROGRESS: "You should go to Flippy and deliver that recommendation letter.",
                   ...
                   9990: {QUEST: "Lord Lowdenclear has a special task for the best of the best.\x07"
                                 "If you want further details, go talk to Flippy._where_"},
                   9991: {GREETING: 'Toons of the World, Unite!',
                          LEAVING: 'Good Luck!',
                          QUEST: "Welcome back, Ranger.  Ready for Lord Lowden Clear's challenge?\x07"
                                 "For this task, you will have to take on all four of the C.O.G.S. bosses.\x07"
                                 "First, go defeat the Director of Marketing four times.",
                          INCOMPLETE_PROGRESS: "Forgot where to find the Director?\x07"
                                               "Sellbot Headquarters is just beyond Daffodil Gardens.", },
                   9992: {GREETING: '',
                          LEAVING: '',
                          QUEST: "Good, that's one boss down.\x07"
                                 "Now, go defeat the Chief Financial Officer three times.",
                          INCOMPLETE_PROGRESS: "Head over to Cashbot Headquarters.  That's where you'll find the CFO!"},
                   9993: {GREETING: '',
                          LEAVING: '',
                          QUEST: "Next up is the Chief Justice, defeat him twice.\x07"
                                 "Make sure you have enough Jury Notices first!",
                          INCOMPLETE_PROGRESS: "You should know where Lawbot HQ is by now.  Go and take on the CJ!"},
                   9994: {GREETING: '',
                          LEAVING: '',
                          QUEST: "Finally, head over to Bossbot HQ...\x07"
                                 "...and take on the Chief Executive Officer!\x07"
                                 "You may need a lot of Stock Options to get a promotion.",
                          INCOMPLETE_PROGRESS: "You're almost there, don't give up now!",
                          COMPLETE: "Excellent work, _avName_.\x07"
                                    "You have proven yourself to be a valuable asset to the Resistance.\x07"
                                    "I'll let Lord Lowden Clear know that you completed his challenge.\x07"
                                    "The Toon Council would like to congratulate you for completing every Toontask!\x07"
                                    "If we ever need your help in the future, we'll let you know!\x07"
                                    "In the meantime, I have one more reward for you..."}}
...
AvatarPanelCogLevel = 'Level: %(level)s%(exe)s%(revives)s'
...
SpokenMoods = {'neutral': 'neutral',
               ...
               'boredom': ["I'm dying of boredom over here!", "You didn't think I understood you, huh?",
               ...
               'sadness': [
                   ...
                   "I'll be good, I promise!", "I don't know WHY I'm sad, I just am!!!"],
               ...
               'fatigue': ['That swim in the pond really tired me out!', 'Being a Doodle is exhausting!',
                           'I gotta get to Dreamland!'],
               'confusion': ['Where am I? Who are you again?', "What's a Toon-up again?",
                             "Whoa, I'm standing between you and the Cogs! Run away!"],
               'anger': ['... and you wonder why I never give you a Toon-up?!!!', 'You always leave me behind!',
                         'You love your gags more than you love me!'],
               'surprise': ['Of course Doodles can talk!', 'Toons can talk?!!', 'Whoa, where did you come from?'],
               'affection': ["You're the best Toon EVER!!!!!!!!!!", 'Do you even KNOW how great you are?!?',
...
SuitForecaster = 'Forecaster'
SuitAffiliate = 'Affiliate'
SuitProspector = 'Prospector'
SuitTrafficManager = 'Traffic Manager'
SuitGatekeeper = 'Gatekeeper'
SuitFirstMover = 'First Mover'
...
SuitForecasterS = 'a Forecaster'
SuitAffiliateS = 'an Affiliate'
SuitProspectorS = 'a Prospector'
SuitTrafficManagerS = 'a Traffic Manager'
SuitGatekeeperS = 'a Gatekeeper'
SuitFirstMoverS = 'a First Mover'
...
SuitForecasterP = 'Forecasters'
SuitAffiliateP = 'Affiliates'
SuitProspectorP = 'Prospectors'
SuitTrafficManagerP = 'Traffic Managers'
SuitGatekeeperP = 'Gatekeepers'
SuitFirstMoverP = 'First Movers'
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
                    ...
                    'DigUp': ['This will certainly ruin your PR.',
                              'Care to explain... THIS?',
                              "I don't see you getting out of this mess.",
                              "I'm going to expose all your misdeeds.",
                              'What if I told the others about what you did?',
                              "You're in deep trouble!",
                              "I hope you don't have skeletons in your closet.",
                              'Getting nervous? Maybe we should dig deeper.',
                              'You can never escape your past.',
                              "Don't think that I forgot about this incident!"],
                    'DoubleTalk': ["Let's talk this one over.",
                                   'Our conversation will increase productivity twofold.',
                                   "I'm sure we can be on good terms.",
                                   "These words won't come back to bite you.",
                                   "I'm going to double-down!",
                                   'Let me know if this is \"two\" much for you.',
                                   'You can count on me - twice, even.',
                                   "I'll speak loud and clear with you, trust me.",
                                   'Talk with me, two-on-one.',
                                   'If words have weight, mine are twice as heavy.',
                                   "Here's my two cents...",
                    ...
                    'WhistleBlow': ["I won't stand for this!",
                                    'Stop right there!',
                                    'Time-out!',
                                    ...
                                    'Everyone is going to notice this.',
...
MickeyChatter = (['Welcome to ' + lToontownCentral + '.', 'Hi, my name is ' + Mickey + ". What's yours?"],
                 ['Hey, have you seen ' + Donald + '?',
                  "I'm going to go watch the fog roll in at " + lBoatyard + '.',
                 ...
                 ["I'm going to Melodyland to see " + Minnie + '!',
                  ...
                  "I think I'll go swimming at " + lBoatyard + '.',
...
MinnieChatter = (['Welcome to Melodyland.', 'Hi, my name is ' + Minnie + ". What's yours?"],
                 ['The hills are alive with the sound of music!',
                  ...
                  "I heard it's foggy at the " + lBoatyard + '.',
                  'Be sure and try the maze in ' + lGardens + '.',
                 ...
                 ["Gosh, I'm late for my date with %s!" % Mickey, "Looks like it's time for %s's dinner." % Pluto,
                  "It's time for a nap. I'm going to Dreamland."])
...
WinterMinnieDChatter = (["Hi, I'm Merry Minnie!",
                         ...
                         'Happy Winter Holiday, %!'], ['Belt out a tune, Toon!',
                                                       ...
                                                       'Everything looks better with a wreath!'],
                        ['Have a fun Winter Holiday!', 'Happy Trails!', 'Mickey is taking me caroling!'])
ValentinesMinnieChatter = (["Hello, I'm Minnie!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %"],
...
WitchMinnieChatter = (['Welcome to Magicland... I mean Melodyland!',
                      ...
                      ["I'm going to disappear now!", 'Time for me to vanish!',
...
DaisyChatter = (['Welcome to my garden!', "Hello, I'm " + Daisy + ". What's your name?", "It's so nice to see you %!"],
                ['My prize winning flower is at the center of the garden maze.',
                 ...
                 'There are far too many ' + Cogs + ' near ' + lBoatyard + '.',
...
ValentinesDaisyChatter = (["Hi, I'm Daisy!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %"],
...
WinterDaisyCChatter = (
    ['Welcome to the only garden that grows in the winter!', 'Happy Winter Holiday!', 'Happy Winter Holiday, %!'],
...
WinterDaisyDChatter = (
    ...
    ['My garden needs more mistletoe!',
     ...
     'I grew all these lights myself!'], ['Have a jolly Winter Holiday!',
                                          ...
                                          'Tell Donald to stop by with presents!',
                                          'Donald is taking me caroling!'])
HalloweenDaisyChatter = (['Welcome to Daisy Ghosts... I mean Gardens!', 'Happy Halloween!', 'Happy Halloween, %!'],
                         ['Visit my friend Leif Pyle if you have a trick and Rake Inn the treats!',
                          ...
                          'Visit my friend Leif Pyle if you have a trick and Rake Inn the treats!',
                          'I hope you are enjoying our Halloween fun!'], ['Donald is taking me Trick-or-Treating!',
...
ChipChatter = (['Welcome to %s!' % lOutdoorZone,
                ...
                'We are Chip and Dale!'], ['I like golf.', 'We have the best acorns in Toontown.',
...
ValentinesChipChatter = (
    ...
    ['Come back any time!'])
WinterChipChatter = (
    ['Happy Winter Holiday!', 'Dressed as chipmunks!', 'Happy Winter Holiday, %!'], ['Happy Winter Holiday, Dale!',
...
HalloweenChipChatter = (
    ['Play some MiniGhoul... I mean Golf!', 'Happy Halloween!', 'Happy Halloween, %!'], ["We're nuts about Halloween!",
                                                                                         "You're under arrest",
...
DaleChatter = (["It's so nice to see you %!",
               ...
               ['I like picnics.', 'Acorns are tasty, try some.', 'Those windmills can be hard too.'],
...
ValentinesDaleChatter = (
    ["I'm Dale!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %!"], ['Same thing as last year. Nothing!',
                                                                           'I miss the nuts!',
...
HalloweenDaleChatter = (
    ['Happy Halloween, %!', 'Play some MiniGhoul... I mean Golf!', 'Happy Halloween!'], ["We're nuts about Halloween!",
    ...
    ['%, watch out for Bloodsucker Cogs!'])
GoofyChatter = (
    ['Welcome to ' + lGardens + '.', 'Hi, my name is ' + Goofy + ". What's yours?",
    ...
    ['Boy it sure is easy to get lost in the garden maze!',
     ...
     'Gawrsh there sure are a lot of ' + Cogs + ' near ' + lBoatyard + '.',
...
WinterGoofyChatter = (["I'm Goofy about the holidays!",
                      ...
                      ['Have a cheery Winter Holiday!', 'Drive safe, now!', 'Watch out for flying reindeer!'])
ValentinesGoofyChatter = (["I'm Goofy about ValenToon's Day!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %!"],
...
GoofySpeedwayChatter = (['Welcome to ' + lRaceway + '.', 'Hi, my name is ' + Goofy + ". What's yours?",
                         "Gawrsh, it's nice to see you %!"], ['Boy, I saw a terrific race earlier.',
...
SuperGoofyChatter = (['Welcome to my Super Speedway!',
                      ...
                      'Happy Halloween, %!'], ['I am feeling kind of batty today!',
                                               ...
                                               'I hope you are enjoying our Halloween fun!'], ['Gotta fly!',
                                                                                               'Hi-Ho and away I go!',
                                                                                               "Should I fly or drive to Barnacle Boatyard?",
...
DonaldChatter = (
    ...
    ['Sometimes this place gives me the creeps.',
     ...
     "I think I'll go fishing this afternoon.",
     'Wow, there are lots of ' + Cogs + ' at ' + lBoatyard + '.',
     "Hey, didn't I take you on a boat ride at " + lBoatyard + '?',
     "I haven't seen " + Daisy + ' all day.',
     'I hear ' + Daisy + ' has planted some new flowers in her garden.',
     'Quack.'],
    ["I'm going to Melody Land to see %s!" % Minnie,
...
WinterDreamlandDChatter = (["Hi, I'm Dozing Donald!",
                            ...
                            'Happy Winter Holiday, %!'], ['I wish I was nestled all snug in my bed!',
                                                          ...
                                                          'The trees on the streets are covered in night lights!'],
                           ['To all, a good night!', 'Sweet dreams!', 'When I wake up I am going caroling!'])
HalloweenDreamlandChatter = (['Happy Halloween!', 'Happy Halloween, %!', "Hi, I'm FrankenDonald!"],
                             ['If you can play a trick on my friend Max, then you can Relax To The Max with a treat!',
                              ...
                              'If you can play a trick on my friend Max, then you can Relax To The Max with a treat!',
                              'I hope you are enjoying our Halloween fun!'],
                             ['Sleep with the lights on tonight!', 'When I wake up, I am going Trick-or-Treating!'])
ValentinesDreamlandChatter = (["Hello, I'm (yawn) Donald!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %!"],
...
HalloweenDonaldChatter = (['Welcome to my Halloween harbor!',
                          ...
                          ['If playing tricks is making you feel Rudderly Ridiculous, then go see Rudy for a treat!',
                           ...
                           'If playing tricks is making you feel Rudderly Ridiculous, then go see Rudy for a treat!',
                           'I hope you are enjoying our Halloween fun!'], ['Set sail for scares!', 'Happy haunting!',
                                                                           "I'm going to check out the spooky Halloween decorations."])
ValentinesDonaldChatter = (["Ahoy, I'm Donald!", "Happy ValenToon's Day!", "Happy ValenToon's Day, %!"],
...
WinterDonaldCChatter = (["Welcome to Donald's Boat and Sleigh Dock!",
                         ...
                         'Happy Winter Holiday, %!'], [
                            ...
                            'I hear that Dante has Gifts With A Porpoise, share a song and he may have a gift for you too!'],
                        ['All ashore for holiday fun!', 'Remember to tip your boat driver on the way out!',
                         'Enjoy your holiday!'])
WinterDonaldDChatter = (["Welcome to Donald's Boat and Sleigh Dock!",
                        ...
                        ['All ashore for holiday fun!', 'Remember to tip your boat driver on the way out!',
                         'Enjoy your holiday!'])
WesternPlutoChatter = (
    ["Boo! Don't be scared, it's just me ... Pluto!", 'Happy Halloween, pardner!', 'Happy Halloween, %!'],
    ...
    ["I'm going to go dig up a treat!", "I'm going to see if Mickey has some treats!", "I'm going to scare Donald!"])
WinterPlutoCChatter = (["Hi, I'm Pluto!",
                       ...
                       ['Have a fun Winter Holiday!', 'Come back any time you want snow!',
...
WinterPlutoDChatter = (["Hi, I'm Pluto!",
                       ...
                       ['Have a fun Winter Holiday!', 'Come back any time you want snow!',
                        'Mickey is taking me caroling!'])
AFMickeyChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"], ["Welcome to the Gardens! I'm " + Daisy + '!',
...
AFDaisyChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"],
                  ['Welcome to ' + lToontownCentral + "! I'm " + Mickey + ' Mouse!',
                   ...
                   "April Toons' Week is the silliest week of the year!",
                   'Have you heard your Doodle talk yet?',
                   'Gravity has taken a holiday at the Estates!'], ['Bye! Tell them ' + Mickey + ' sent you!',
                                                                    'If you go to ' + lGardens + ', say hi to her for me!'])
AFGoofySpeedwayChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"], ["Welcome to Dreamland! I'm " + Donald + '!',
                                                                  ...
                                                                  'Have you heard your Doodle talk yet?',
                                                                  'Gravity has taken a holiday at the Estates!'],
    ['If you see ' + Goofy + ', tell him ' + Donald + ' says hi!', 'Bye, and good night!'])
AFDonaldChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"], ["Welcome to the Speedway! I'm " + Goofy + '!',
...
AFDonaldDockChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"], ["Everybody gets April Toons' Week off but me!",
...
AFPlutoChatter = (
    ["Happy April Toons' Week!", "Happy April Toons' Week, %!"], ["Welcome to Melodyland!  I'm " + Minnie + '!',
                                                                  ...
                                                                  'Have you heard your Doodle talk yet?',
                                                                  'Gravity has taken a holiday at the Estates!'],
    ["Have a wacky April Toons' Week!", 'If you see ' + Pluto + ', tell him ' + Minnie + ' says hi!'])
...
AFDaleChatter = (["Happy April Toons' Week!", "Happy April Toons' Week, %!"], ["Hi, I'm " + Chip + '!',
                 ...
                 ['Or ' + Dale + ' and ' + Chip + '!'])
CLGoofySpeedwayChatter = (['Welcome to ' + lRaceway + '.',
...
GPGoofySpeedwayChatter = (['Welcome to ' + lRaceway + '.',
...
SillyPhase2Chatter = ['Silly levels are still rising!',
                      ...
                      'Someone saw a trash can moving on Daisy Drive!',
...
toontownDialogues = {BoringTopic: {
    ...
    AprilToonsExtPhaseTopTopic: {
        (1, 2020): ['The Silly Meter has hit the top!', 'Doodles are talking, Estates are bouncy!']},
...
MusicMmNbrhood = "Mezzo Melodyland"
MusicGzPlaygolf = "Let's Play Golf!"
MusicGsSz = 'Roadster Raceway'
...
MusicDdNbrhood = "Barnacle Boatyard"
...
TrackSetInfo = "You can set this frame to a track you don't own.  " \
               "You will need 2 of the gag's frames to unlock the gag track.  " \
               "If you already unlocked the track, then you can add another frame to prestige it."
...
TownBattleSuitLevel = 'Level %(level)s%(exe)s%(revives)s'
...
ForcedLeaveStageAckMsg = 'The ' + Clerk + ' was defeated before you could reach him. You did not recover any Jury Notices.'
...
STOREOWNER_BROWSING = 'You can browse, but you need 200 jellybeans to buy.'
...
RescueToonIntro = 'You guys made it! The Director of Marketing is in the middle of a meeting right now.'
RescueToonPlan = 'Reports have come in that he has a Resistance Ranger captive!'
RescueToonMeetup = "You guys go ahead and confront him, I'll see what I can do to rescue them."
SellbotBossReports = "We've experienced a sudden dip in sales recently."
SellbotBossBattlePlan = 'We need a new plan to take on those toons.'
SellbotBossCaptive = 'At the very least, I have one of their friends held captive here.'
SellbotBossHigherUp = "I'll speak to the boss. Maybe I'll get a new manager cog!"
SellbotBossVisitors1 = 'Ah, Sellbots! Are you here for a promotion?'
SellbotBossVisitors2 = 'Let me go get the papers...'
CagedToonMuttering = 'Byers, what are you doing here...?'
RescueToonMuttering = "I'm here to recue you, Rain! Just stay still,"
SellbotBossAlerted = "Another toon..? What's going on, here?"
RescueToonRunAway = 'Uh oh, gotta run!'
RescueToonCaptured = 'OOF!'
CagedToonQuestion = 'No!!! Byers, why would you come alone?'
RescueToonFriends = "That's not true! I've got friends on their way right now."
SellbotBossDiscoverToons1 = 'Hold on...'
SellbotBossDiscoverToons2 = 'You Sellbots are toons in disguise!'
SellbotBossAttack = 'Attack!!'
CagedToonDrop = ["The cage is being lowered, keep it up!",
                 'Great work!',
...
SellbotBossHoldOn = 'Wait just a minute!'
SellbotBossBackup1 = 'I still have another trick up my sleeve!'
SellbotBossBackup2 = 'I always keep a supply of mini-skelecogs, perfect for expedited shipping!'
CagedToonMiniCogInfo = "Be careful, toons! Those mini-skelecogs are more nimble than your average cog!"
CagedToonBattlePlan = "If you can clear them out, I'll go grab our supply!"
CagedToonHooray = 'Hooray!'
CagedToonPrepareBattleThree = "Now's our chance to fight back, fellas!"
RescueToonPlaceCooler = "Get to the cooler and grab some pie slices!"
RescueToonStrategy1 = "Rain will stay nearby and help you out, and I'll stand by the balcony."
RescueToonStrategy2 = "If you happen to find any cogs, defeat them for some bonuses!"
RescueToonStrategy3 = "Bring me some cog-bucks, and I'll trade them for some cake slices."
...
CagedToonThankYou = "Well done, toons!\x07I'm sure the Director will return, but in the meantime, I've got some new SOS cards for you!\x07Remember to call them if you ever need help."
CagedToonPromotion = "\x07I'll go fill out the papers to get your disguise promoted.\x07Once promoted, you will need to obtain some more invoices."
CagedToonLastPromotion = "\x07Wow, you've reached level %s on your Cog suit!\x07You are done with promotions, but feel free to check up on me any time."
CagedToonHPBoost = "\x07You've been a great help in rescuing me so far.\x07The Toon Council grants you a bonus laff point. Congratulations!"
CagedToonMaxed = "\x07I see that you have a level %s Cog suit. Very impressive!\x07You can come back to check up on me at any time."
CagedToonGoodbye = 'Good luck out there!'
CagedToonBattleThree = {10: "Take some pie slices, there's plenty to go around!",
                        11: 'Nice! Those pies should help you take him down.',
                        12: 'Run back if you ever need more!',
                        20: "Head to the cooler, we've got pies to throw!",
                        21: 'Out of money? Need more pies? Run to the cooler!',
                        100: 'Use the ACTION key to lob a shot, or tap SECONDARY to throw far!',
                        101: 'The blue power meter shows how high the throw will go.',
                        102: 'First, try to hit his undercarriage to gum up his works.',
                        103: 'Wait for his hatches to open, and then throw a pie inside.',
                        104: "When he's dizzy, hit him in the face or chest to knock him back!",
                        105: "If you hit a Toon with a throw gag, they'll get laff points!"}
RescueToonBattleThree = {10: 'Great work! Take some cake slices.',
                         11: "You've earned them!",
                         12: "Now show him who's boss!",
                         100: "Don't get too close to him, he might swipe you!",
                         101: 'The Director will work harder to stay up the further out he goes.',
                         102: "He'll shower you with gears if you stand right in front of him.",
                         103: "Don't get too far away, or he'll start shaking the ground!",
                         104: 'Try not to get hit by incoming cogs!',
                         105: "He's got some traps on the balcony, be careful!",
                         200: 'The Director just hit the big door! Make sure he stays out!',
                         201: 'Oh no, the Director has re-entered the office!',
                         202: 'So close! Make sure he breaks that railing next time.',
                         203: 'The railing is about to break!',
                         204: 'Farewell, Market Man!'}
CagedToonBattleThreeMaxGivePies = 12
CagedToonBattleThreeMaxTouchCage = 21
CagedToonBattleThreeMaxAdvice = 105
RescueToonBattleThreeMaxGiveCakes = 12
RescueToonBattleThreeMaxAdvice = 105
...
GlassesStylesDescriptions = {'grd1': 'Round Glasses',
                             ...
                             'gmt3': 'Blue Carnintervale Mask',
                             'gmt4': 'Purple Carnintervale Mask',
                             'gmt5': 'Aqua Carnintervale Mask',
                             'gmn1': 'Monocle',
                             'gmo1': 'Smooch Glasses',
...
for accessoryId in CatalogAccessoryItemGlobals.AccessoryTypes.keys():
    ...
    if accessoryInfo[3]:
        AwardManagerAccessoryNames[accessoryId] = AccessoryNamePrefix[accessoryInfo[0]] + accessoryStyleDescription[
            accessoryInfo[1]]
...
ShirtStylesDescriptions = {'bss1': 'solid',
                           ...
                           'sa_ss27': 'Award Most Directors Defeated Shirt',
...
SpecialEventMailboxStrings = {1: 'A special item from the Toon Council just for you!',
                              ...
                              14: 'Here is your Most Directors Defeated Tournament prize! Congratulations!',
...
ClothingTypeNames = {1001: 'Ghost Shirt',
                     ...
                     1764: 'Most Directors Defeated Shirt',
...
TipDict = {TIP_NONE: ('',),
           TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
                         ...
                         "Show off your stylin' ride and turbo-boost your Laff limit at Roadster Raceway.",
                         'Enter Roadster Raceway through the tire-shaped tunnel in Toontown Central Playground.',
                         'Earn Laff points at Roadster Raceway.',
                         'Roadster Raceway has six different race tracks. '),
           ...
           TIP_MINIGAME: (
               ...
               'Trolley Game difficulty varies by neighborhood; ' + lToontownCentral + ' has the easiest and ' + lDreamland + ' has the hardest.',
               'Certain Trolley Games can only be played in a group.'),
           TIP_COGHQ: ('You must complete your Sellbot Disguise before visiting the Director.',
                       ...
                       'When you collect enough Cog Merits to earn a promotion, go see the Sellbot Director!',
                       ...
                       'Up to eight Toons can join together to fight the Sellbot Director.',
                       ...
                       "Earn Cashbot disguise suit parts as rewards for completing ToonTasks in Drowsy Dreamland.",
           ...
           TIP_KARTING: ("Buy a Roadster, TUV, or Cruiser kart in Goofy's Auto Shop.",
                         ...
                         'Earn tickets by kart racing at Roadster Raceway.',
                         ...
                         'Screwball Stadium is the easiest track at Roadster Raceway.',
                         'Airborne Acres has the most hills and jumps of any track at Roadster Raceway.',
                         'Blizzard Boulevard is the most challenging track at Roadster Raceway.'),
...
SellbotLegFactorySpecPaintMixer = 'East Oil Processor'
SellbotLegFactorySpecPaintMixerStorageRoom = 'Eastern Storage Room'
...
SellbotLegFactorySpecLavaRoomFoyer = 'Gague Room'
SellbotLegFactorySpecLavaRoom = 'West Oil Processor'
SellbotLegFactorySpecLavaStorageRoom = 'Western Storage Room'
SellbotLegFactorySpecWestCatwalk = 'West Catwalk'
SellbotLegFactorySpecOilRoom = 'Distillation Room'
SellbotLegFactorySpecLookout = 'Lookout'
SellbotLegFactorySpecWarehouse = 'Warehouse'
SellbotLegFactorySpecWarehouseStorageRoom = 'Warehouse Storage Room'
SellbotLegFactorySpecOilRoomHallway = 'Distillation Room Hallway'
...
CircuitRaceStart = 'The Toontown Grand Prix at Roadster Raceway is about to begin!  To win, collect the most points in three consecutive races!'
CircuitRaceOngoing = 'Welcome! The Toontown Grand Prix is currently in progress.'
CircuitRaceEnd = "That's all for today's Toontown Grand Prix at Roadster Raceway.  See you next week!"
...
GolfTrophyDescriptions = [str(GolfGlobals.TrophyRequirements[GolfGlobals.CoursesCompleted][0]) + ' ' + CoursesCompleted,
                          ...
                          str(GolfGlobals.TrophyRequirements[GolfGlobals.EagleOrBetterShots][
                                  0]) + ' ' + EagleOrBetterShots,
                          str(GolfGlobals.TrophyRequirements[GolfGlobals.EagleOrBetterShots][
                                  1]) + ' ' + EagleOrBetterShots,
                          str(GolfGlobals.TrophyRequirements[GolfGlobals.EagleOrBetterShots][
                                  2]) + ' ' + EagleOrBetterShots,
                          str(GolfGlobals.TrophyRequirements[GolfGlobals.BirdieOrBetterShots][
                                  0]) + ' ' + BirdieOrBetterShots,
                          str(GolfGlobals.TrophyRequirements[GolfGlobals.BirdieOrBetterShots][
                                  1]) + ' ' + BirdieOrBetterShots,
                          str(GolfGlobals.TrophyRequirements[GolfGlobals.BirdieOrBetterShots][
                                  2]) + ' ' + BirdieOrBetterShots,
                          ...
                          str(GolfGlobals.TrophyRequirements[GolfGlobals.MultiPlayerCoursesCompleted][
                                  0]) + ' ' + MultiPlayerCoursesCompleted,
                          str(GolfGlobals.TrophyRequirements[GolfGlobals.MultiPlayerCoursesCompleted][
                                  1]) + ' ' + MultiPlayerCoursesCompleted,
                          str(GolfGlobals.TrophyRequirements[GolfGlobals.MultiPlayerCoursesCompleted][
                                  2]) + ' ' + MultiPlayerCoursesCompleted,
...
GolfCupDescriptions = [str(GolfGlobals.TrophiesPerCup) + ' Trophies won',
...
GrandPrixWeekendHolidayStart = "It's Grand Prix Weekend at Roadster Raceway! Free and paid players collect the most points in three consecutive races."
...
KartingTicketsHolidayStart = 'Get double tickets from Practice races at Roadster Raceway today!'
...
CountryClubBossConfrontedMsg = '%s is battling the ' + ClubPresident + '!'
...
HolidayNamesInCalendar = {
    ...
    14: (
        'Grand Prix',
        'Grand Prix Monday at Roadster Raceway! To win, collect the most points in three consecutive races!'),
    16: ('Grand Prix Weekend', 'Free and Paid players compete in circuit races at Roadster Raceway!'),
    ...
    105: ('Toons go GREEN!', 'Toons make a green scene at Green Bean Jeans on Tulip Terrace in Daffodil Gardens!')}
