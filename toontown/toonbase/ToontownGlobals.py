...
def getBuildingNametagFont():
    ...
    if BuildingNametagFont is None:
...
HoodHierarchy = {ToontownCentral: (SillyStreet, LoopyLane, PunchlinePlace),
                 DonaldsDock: (BuccaneerBoulevard, SeaweedStreet, LighthouseLane),
                 TheBrrrgh: (WalrusWay, SleetStreet, PolarPlace),
                 MinniesMelodyland: (AltoAvenue, BaritoneBoulevard, TenorTerrace),
                 DaisyGardens: (PetuniaPlace, DaisyDrive, TulipTerrace),
...
BossbotCountryClubCogLevel = 10
BossbotCountryClubSkelecogLevel = 11
BossbotCountryClubCaddieLevel = 14
...
FT_Arm = 'arm'
FT_Torso = 'torso'
facilityIdToType = {MockupFactoryId: FT_FullSuit,
                    SellbotFactoryInt: FT_FullSuit,
                    CashbotMintIntA: FT_Leg,
                    CashbotMintIntB: FT_Arm,
                    CashbotMintIntC: FT_Torso,
                    LawbotStageIntA: FT_Leg,
                    LawbotStageIntB: FT_Arm,
                    LawbotStageIntC: FT_Torso,
                    LawbotStageIntD: FT_FullSuit,
...
NumEmblemTypes = 2
DefaultMaxBankMoney = 0
DefaultMaxMoney = 60000
