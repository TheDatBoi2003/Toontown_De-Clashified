...
class DistributedCEOGoonAI(DistributedCashbotBossGoonAI.DistributedCashbotBossGoonAI):
    ...
    def enterCogGoon(self):
        self.avId = 0
        self.craneId = 0
        self.setPosHpr(-65, 257, 0.025, 90, 0, 0)
        self.d_setPosHpr(-65, 257, 0.025, 90, 0, 0)
