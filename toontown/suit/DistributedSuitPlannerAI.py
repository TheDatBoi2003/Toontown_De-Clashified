...
class DistributedSuitPlannerAI(DistributedObjectAI.DistributedObjectAI, SuitPlannerBase.SuitPlannerBase):
    ...
    SuitHoodInfo = [
        [2100, 5, 15, 0, 5, 20, 3, (1, 5, 10, 40, 60, 80), (25, 25, 25, 25), (1, 2, 3), 0.1, []],
        [2200, 3, 10, 0, 5, 15, 3, (1, 5, 10, 40, 60, 80), (10, 70, 10, 10), (1, 2, 3, 4), 0.05, []],
        [2300, 3, 10, 0, 5, 15, 3, (1, 5, 10, 40, 60, 80), (10, 10, 40, 40), (1, 2, 3), 0.05, []],
        [1100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (90, 10, 0, 0), (2, 3, 4, 5), 0.075, []],
        [1200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 90, 10), (2, 3, 4, 5), 0.1, []],
        [1300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (40, 40, 10, 10), (2, 3, 4, 5), 0.1, []],
        [3100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (90, 10, 0, 0), (6, 7, 8), 0.2, []],
        [3200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (10, 20, 30, 40), (6, 7, 8, 9), 0.2, []],
        [3300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 85, 5, 5), (7, 8, 9), 0.25, []],
        [4100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 50, 50), (4, 5, 6, 7), 0.075, []],
        [4200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 0, 90, 10), (5, 6, 7, 8), 0.1, []],
        [4300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (50, 50, 0, 0), (5, 6, 7, 8), 0.1, []],
        [5100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (0, 20, 10, 70), (4, 5, 6), 0.75, []],
        [5200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (10, 70, 0, 20), (4, 5, 6, 7), 0.1, []],
        [5300, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 5, 5, 85), (5, 6, 7), 0.15, []],
        [9100, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (25, 25, 25, 25), (8, 9, 10), 0.25, []],
        [9200, 1, 5, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 5, 85, 5), (8, 9, 10, 11), 0.3, []],
        [11000, 3, 15, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 0, 100), (4, 5, 6, 7), 0.25, []],
        [11200, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 0, 100), (4, 5, 6, 7), 0.25, []],
        [12000, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 0, 100, 0), (5, 6, 7, 8), 0.25, []],
        [13000, 10, 20, 0, 0, 0, 4, (1, 5, 10, 40, 60, 80), (0, 100, 0, 0), (5, 6, 7, 8, 9), 0.25, []]]
    ...
    def createNewSuit(self, blockNumbers, streetPoints, toonBlockTakeover=None, cogdoTakeover=None, minPathLen=None, maxPathLen=None, buildingHeight=None, suitLevel=None, suitType=None, suitTrack=None, suitName=None, skelecog=None, revives=None):
        ...
        if blockNumber is not None:
            ...
            if newSuit.attemptingTakeover:
                ...
                if suitTrack is None and len(pendingTracks) > 0:
                    if cogdoTakeover:
                ...
                if buildingHeight is None and len(pendingHeights) > 0:
        ...
        if suitType is None and suitName:
            suitType = SuitBattleGlobals.SuitAttributes[suitName]['level']
            suitTrack = SuitDNA.getSuitDept(suitName)
        if suitLevel is None and buildingHeight:
            if not cogdoTakeover:
        ...
        executive = random.random() <= self.SuitHoodInfo[self.hoodInfoIdx][self.SUIT_HOOD_INFO_EXE]
        suitLevel, suitType, suitTrack = self.pickLevelTypeAndTrack(suitLevel, suitType, suitTrack)
        if suitName:
            newSuit.setupSuitDNA(suitLevel, suitTrack, executive, suitName)
        else:
            newSuit.setupSuitDNA(suitLevel, suitTrack, executive, hqZone=(
                    self.SuitHoodInfo[self.hoodInfoIdx][self.SUIT_HOOD_INFO_ZONE] >= 10000))
    ...
    def assignSuitBuildings(self, numToAssign):
        ...
        while numToAssign > 0:
            smallestCount = None
            smallestTracks = []
            for trackIndex in xrange(len(SuitDNA.suitDepts)):
    ...
    def __suitCanJoinBattle(self, zoneId):
        ...
        if len(battle.suits) >= SuitBattleGlobals.MAX_SUIT_CAPACITY:
            return 0
        if battle:
    ...
    def pickLevelTypeAndTrack(self, level=None, type=None, track=None):
        ...
        if type is None:
            typeChoices = list(SuitDNA.getSuitDataOfDeptAndLvl(track, level).values())
            type = random.choice(typeChoices)['level']
