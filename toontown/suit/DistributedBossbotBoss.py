...
class DistributedBossbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def __init__(self, cr):
        ...
        self.grunt = loader.loadSfx('phase_9/audio/sfx/Boss_c_COG_VO_grunt.ogg')
        self.murmur = loader.loadSfx('phase_9/audio/sfx/Boss_c_COG_VO_murmur.ogg')
        self.statement = loader.loadSfx('phase_9/audio/sfx/Boss_c_COG_VO_statement.ogg')
        self.question = loader.loadSfx('phase_9/audio/sfx/Boss_c_COG_VO_question.ogg')
        self.bossDamage = 0
    ...
    def disable(self):
        ...
        self.interruptMove()
        for interval in self.bossClubIntervals:
            interval.finish()
    ...
    def localToonTouchedChair(self, tableIndex, chairIndex):
        avId = base.localAvatar.doId
        if avId in self.toonFoodStatus and self.toonFoodStatus[avId]:
