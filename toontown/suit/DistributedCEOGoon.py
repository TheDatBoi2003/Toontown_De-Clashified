...
class DistributedCEOGoon(DistributedCashbotBossGoon.DistributedCashbotBossGoon):
    ...
    def __startWalk(self):
        self.walkTrack = Sequence(self.hprInterval(6, VBase3(-90, 0, 0)),
                                  self.posInterval(15, Point3(76, 260, 0.025)),
                                  self.hprInterval(6, VBase3(90, 0, 0)),
                                  self.posInterval(15, Point3(-65, 257, 0.025)))
        self.walkTrack.loop()
