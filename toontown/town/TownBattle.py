...
from toontown.town import TownBattleSuitPanel
...
class TownBattle(StateData.StateData):
    ...
    def __init__(self, doneEvent):
        ...
        self.cogFireCosts = [None] * SuitBattleGlobals.MAX_SUIT_CAPACITY
        self.toonPanels = []
        for i in xrange(ToontownBattleGlobals.MAX_TOON_CAPACITY):
