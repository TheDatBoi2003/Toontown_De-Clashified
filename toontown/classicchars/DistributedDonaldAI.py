...
class DistributedDonaldAI(DistributedCCharBaseAI.DistributedCCharBaseAI):
    ...
    def __init__(self, air):
        ...
        self.fsm = ClassicFSM.ClassicFSM('DistributedDonaldAI', [State.State('Off', self.enterOff, self.exitOff, ['Lonely', 'TransitionToCostume', 'Walk']),
    ...
    def handleHolidays(self):
        ...
        if hasattr(simbase.air, 'holidayManager'):
            if ToontownGlobals.APRIL_FOOLS_COSTUMES in simbase.air.holidayManager.currentHolidays:
                if simbase.air.holidayManager.currentHolidays[ToontownGlobals.APRIL_FOOLS_COSTUMES] and simbase.air.holidayManager.currentHolidays[ToontownGlobals.APRIL_FOOLS_COSTUMES].getRunningState():
