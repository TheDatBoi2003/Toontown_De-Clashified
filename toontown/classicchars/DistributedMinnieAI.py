...
class DistributedMinnieAI(DistributedCCharBaseAI.DistributedCCharBaseAI):
    ...
    def __init__(self, air):
        ...
        self.fsm = ClassicFSM.ClassicFSM('DistributedMinnieAI', [State.State('Off', self.enterOff, self.exitOff, ['Lonely', 'TransitionToCostume', 'Walk']),
    ...
    def handleHolidays(self):
        ...
        if hasattr(simbase.air, 'holidayManager'):
            if ToontownGlobals.APRIL_FOOLS_COSTUMES in simbase.air.holidayManager.currentHolidays and simbase.air.holidayManager.currentHolidays[ToontownGlobals.APRIL_FOOLS_COSTUMES] and simbase.air.holidayManager.currentHolidays[ToontownGlobals.APRIL_FOOLS_COSTUMES].getRunningState():
