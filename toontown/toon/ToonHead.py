...
class ToonHead(Actor.Actor):
    ...
    EyesOpen.setMinfilter(Texture.FTNearest)
    EyesOpen.setMagfilter(Texture.FTNearest)
    EyesClosed = loader.loadTexture('phase_3/maps/eyesClosed.jpg', 'phase_3/maps/eyesClosed_a.rgb')
    EyesClosed.setMinfilter(Texture.FTNearest)
    EyesClosed.setMagfilter(Texture.FTNearest)
    EyesSadOpen = loader.loadTexture('phase_3/maps/eyesSad.jpg', 'phase_3/maps/eyesSad_a.rgb')
    EyesSadOpen.setMinfilter(Texture.FTNearest)
    EyesSadOpen.setMagfilter(Texture.FTNearest)
    EyesSadClosed = loader.loadTexture('phase_3/maps/eyesSadClosed.jpg', 'phase_3/maps/eyesSadClosed_a.rgb')
    EyesSadClosed.setMinfilter(Texture.FTNearest)
    EyesSadClosed.setMagfilter(Texture.FTNearest)
    EyesAngryOpen = loader.loadTexture('phase_3/maps/eyesAngry.jpg', 'phase_3/maps/eyesAngry_a.rgb')
    EyesAngryOpen.setMinfilter(Texture.FTNearest)
    EyesAngryOpen.setMagfilter(Texture.FTNearest)
    EyesAngryClosed = loader.loadTexture('phase_3/maps/eyesAngryClosed.jpg', 'phase_3/maps/eyesAngryClosed_a.rgb')
    EyesAngryClosed.setMinfilter(Texture.FTNearest)
    EyesAngryClosed.setMagfilter(Texture.FTNearest)
    EyesSurprised = loader.loadTexture('phase_3/maps/eyesSurprised.jpg', 'phase_3/maps/eyesSurprised_a.rgb')
    EyesSurprised.setMinfilter(Texture.FTNearest)
    EyesSurprised.setMagfilter(Texture.FTNearest)
    Muzzle = loader.loadTexture('phase_3/maps/muzzleShrtGeneric.jpg')
    Muzzle.setMinfilter(Texture.FTNearest)
    Muzzle.setMagfilter(Texture.FTNearest)
    MuzzleSurprised = loader.loadTexture('phase_3/maps/muzzleShortSurprised.jpg')
    MuzzleSurprised.setMinfilter(Texture.FTNearest)
    MuzzleSurprised.setMagfilter(Texture.FTNearest)
    ...
    def findSomethingToLookAt(self):
        if self.lookAtPositionCallbackArgs:
