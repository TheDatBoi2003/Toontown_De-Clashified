...
def __doSprinkle(attack, recipients, hp = 0):
    ...
    effectTrack.append(parallelEffects)
...
def __doSmooch(attack, hp = 0):
    ...
    effectTrack.append(parallelTracks)
...
def doNPCTeleports(attacks):
    ...
    for attack in attacks:
        if 'npcId' in attack:
            ...
            if npc:
                ...
                arrinterval = teleportIn(attack, npc, pos=pos)
                arrintervals.append(arrinterval)
    ...
    arrintervals.append(turns)
    unturns.append(departures)
    return (arrintervals, unturns, npcs)
