...
class BattleManagerAI:
    ...
    def newBattle(self, cellId, zoneId, pos, suit, toonId, finishCallback=None,
                  maxSuits=SuitBattleGlobals.MAX_SUIT_CAPACITY, interactivePropTrackBonus=-1):
        if cellId in self.cellId2battle:
            ...
            battle = self.battleConstructor(self.air, self, pos, suit, toonId, zoneId, finishCallback, maxSuits,
